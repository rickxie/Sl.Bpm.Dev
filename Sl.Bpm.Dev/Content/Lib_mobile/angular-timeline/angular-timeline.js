...
angular.module('angular-timeline').directive('timelineEvent', function() {
  return {
    ...
    restrict: 'AE',
    transclude: true,
    template: '<li class="timeline-event" ng-class="processTimelineClass" ng-class-odd="oddClass" ng-class-even="evenClass" ng-transclude></li>',
    link: function(scope, element, attrs, controller) {
      ...
      attrs.$observe('ng-class', function (newValue) {
          console.log(newValue);
          scope.processTimelineClass = newValue;
      });
