...
/**** fm-grid.js *****/
_shared.directive("fmGrid",["mabp.app.module","mabp.app.file","fmTool","$timeout",function(){return{restrict:"E",replace:!0,template:function(n,t){return t.guid=_$.getGUID(),'<div class="jq-grid-bd"><table id="jqgrid'+t.guid+'" class="jq-grid" ><\/table><div class="table-footer"><div class="edit-bd" > <input type = "BUTTON" ng-click="setColShow()" value = "选择列" /> <div class="set-cols"><ul ng-show="setcol"><li style = "text-align: right;line-height: 20px;" > <i class="icon-remove-sign" style="cursor: pointer" ng-click="setColShow()"><\/i><\/li> <li ng-repeat="m in columnConfig" ng-hide="m.name==\'_$rownumber\'"><input type="checkbox" ng-init="m.check=m.hidden==true?false:true" ng-click="colSelect(m)" ng-model="m.check" />{{ m.displayName }}<\/li><\/ul><\/div> <\/div>  <div class="table-footer-pager" ng-if="pageModel.paging.totalCount > 0"> <rs-pager  current-page="pageModel.paging.currentPage" load="pageModel.load()" total-count="pageModel.paging.totalCount" page-size="pageModel.paging.pageSize"><\/rs-pager><\/div> <\/div><\/div>'},scope:{columnConfig:"=",pageModel:"=",rowHandel:"=",height:"=",definedRowclass:"=",multiselect:"="},link:function(n,t,i){var r=$(t).find(".jq-grid"),u=n.pageModel.datas;n.colNames=[];n.pageInit=function(){r.jqGrid({data:n.pageModel.datas,datatype:"local",colNames:n.colNames,colModel:n.columnConfig,rowNum:n.pageModel.paging.pageSize,rowList:[10,20,30],height:n.height||400,multiselect:n.multiselect||!1,gridComplete:function(){for(var u,t,e,f=r.jqGrid("getDataIDs"),i=0;i<n.pageModel.datas.length;i++){if(u="",edit='<i title="编辑" class="icon-edit grid-btn ed"  data-edit="'+i+'"><\/i>',remove='<i title="删除" class="icon-remove-sign grid-btn ed"  data-del="'+i+'"><\/i>',n.pageModel.edit&&(u+=edit),n.pageModel.delete&&(u+=remove),n.pageModel.customHandel)for(t=0;t<n.pageModel.customHandel.length;t++)(!n.pageModel.customHandel[t].isShow||n.pageModel.customHandel[t].isShow(n.pageModel.datas[i]))&&(u+='<i title="'+(n.pageModel.customHandel[t].title||n.pageModel.customHandel[t].text||"")+'" class="grid-btn '+(n.pageModel.customHandel[t].className||"")+'"data-id="'+t+'"  data-custom="'+i+'">'+(n.pageModel.customHandel[t].text||"")+"<\/i>");r.jqGrid("setRowData",f[i],{act:u});e=n.pageModel.datas[i];n.definedRowclass&&e[n.definedRowclass.name]==n.definedRowclass.value&&r.find("#"+f[i]).addClass(n.definedRowclass.class)}},loadComplete:function(){$(t).find(".jq-grid *[data-edit]").click(function(t){n.edit($(this).data("edit"));t.stopPropagation()});$(t).find(".jq-grid *[data-del]").click(function(t){n.del($(this).data("del"));t.stopPropagation()});$(t).find(".jq-grid *[data-custom]").click(function(t){var i=$(this).data("id"),r=$(this).data("custom");n.pageModel.customHandel[i].event(n.pageModel.datas[r]);t.stopPropagation()});r.setGridWidth($(t).width());n.ChangeColumnWidth&&n.ChangeColumnWidth()},onSortCol:function(t,i,r){n.sort(t,r)},onSelectRow:function(t,i,u){var f=n.pageModel.datas[r.find("#"+t)[0].rowIndex-1];u.which!=1||!n.pageModel.clickRow||n.pageModel.clickRow(f);n.pageModel.getSelected&&n.pageModel.getSelected(r.jqGrid("getGridParam","selarrrow"))},ondblClickRow:function(t){var i=n.pageModel.datas[r.find("#"+t)[0].rowIndex-1];!n.pageModel.doubleClickRow||n.pageModel.doubleClickRow(i)},rowNum:100,rowList:[100],onSelectAll:function(){n.pageModel.getSelected&&n.pageModel.getSelected(r.jqGrid("getGridParam","selarrrow"))}})};n.dateFmt=function(){for(var i,t=0;t<n.columnConfig.length;t++)if(!!n.columnConfig[t].datefmt)for(i=0;i<n.pageModel.datas.length;i++)n.pageModel.datas[i][n.columnConfig[t].name]=new Date(n.pageModel.datas[i][n.columnConfig[t].name]).format(n.columnConfig[t].datefmt)};n.load=function(){for(var i=0;i<n.columnConfig.length;i++)n.columnConfig[i].sortable||(n.columnConfig[i].sortable=!1),n.columnConfig[i].key=!1,n.colNames.push(n.columnConfig[i].displayName);!n.pageModel.datas||(n.dateFmt(),n.pageInit(),$(window).resize(function(){r.setGridWidth($(t).width());n.ChangeColumnWidth()}),n.columnConfig[0].frozen&&(setTimeout(function(){r.jqGrid("setFrozenColumns")},3e3),$(t).find(".edit-bd").hide()))};n.load();n.colSelect=function(){for(var r,t=0;t<n.columnConfig.length;t++)n.columnConfig[t].name!="_$rownumber"&&(r=$("td[aria-describedby='jqgrid"+i.guid+"_"+n.columnConfig[t].name+"'],#jqgrid"+i.guid+"_"+n.columnConfig[t].name),n.columnConfig[t].check?(r.show(),$(".jqgfirstrow td").eq(t).show()):(r.hide(),$(".jqgfirstrow td").eq(t).hide()))};n.edit=function(t){n.pageModel.edit($.extend({},n.pageModel.datas[t]))};n.del=function(t){n.pageModel.delete(n.pageModel.datas[t])};n.setColShow=function(){n.setcol=!n.setcol};n.ChangeColumnWidth=function(){for(var t=0;t<n.columnConfig.length;t++)!n.columnConfig[t].colWidth||($(".ui-jqgrid-labels th").eq(t).width(n.columnConfig[t].colWidth),$(".jqgfirstrow td").eq(t).width(n.columnConfig[t].colWidth));$(".ui-jqgrid-htable tr th").each(function(){if($(this)[0].scrollWidth>$(this).outerWidth()){var n=$(this)[0].scrollWidth;$(this).width(n);$(".jqgfirstrow td").eq($(this).index()).width(n)}})};n.sort=function(t,i){n.pageModel.paging.orderByProperty=t;n.pageModel.paging.ascending=i=="asc"?!0:!1;n.pageModel.load()};n.$watch("pageModel.datas",function(){n.dateFmt();r.jqGrid("clearGridData");r.jqGrid("setGridParam",{data:n.pageModel.datas}).trigger("reloadGrid")})}}}]);
