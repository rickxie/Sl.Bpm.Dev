...
/**** fm-grid.js *****/
_shared.directive("fmGrid",["mabp.app.module","mabp.app.file","fmTool","$timeout",function(){return{restrict:"E",replace:!0,template:function(){return'<div class="jq-grid-bd"><table id="jqgrid" class="jq-grid" ><\/table><div id = "pager"'+$("")+' class="jq-pager" ><\/div> <div class="table-footer"><div class="edit-bd" > <input type = "BUTTON" ng-click="setColShow()" value = "选择列" /> <div class="set-cols"><ul ng-show="setcol"><li style="text-align: right;line-height: 20px;"><i class="icon-remove-sign" style="cursor: pointer" ng-click="setColShow()"><\/i><\/li><li ng-repeat="m in columnConfig"><input type="checkbox" ng-init="m.check=true" ng-click="colSelect()" ng-model="m.check"/>{{m.displayName}}<\/li><\/ul><\/div><\/div>  <div class="table-footer-pager" ng-if="pageModel.paging.totalCount > 0"> <rs-pager  current-page="pageModel.paging.currentPage" load="pageModel.load()" total-count="pageModel.paging.totalCount" page-size="pageModel.paging.pageSize"><\/rs-pager><\/div> <\/div><\/div>'},scope:{columnConfig:"=",pageModel:"=",rowHandel:"=",height:"=",definedRowclass:"=",multiselect:"="},link:function(n,t){var i=$(t).find(".jq-grid");n.colNames=[];n.pageInit=function(){i.jqGrid({data:n.pageModel.datas,datatype:"local",colNames:n.colNames,colModel:n.columnConfig,rowNum:n.pageModel.paging.pageSize,rowList:[10,20,30],sortname:n.pageModel.paging.orderByProperty,sortorder:n.pageModel.paging.ascending==!0?"desc":"asc",height:n.height||400,autowidth:!0,multiselect:n.multiselect||!1,gridComplete:function(){for(var e,f,r,o,u=i.jqGrid("getDataIDs"),t=0;t<u.length;t++){if(e=u[t],f="",edit='<i class="icon-edit grid-btn ed"  data-edit="'+e+'"><\/i>',remove='<i class="icon-remove-sign grid-btn ed"  data-del="'+e+'"><\/i>',n.pageModel.edit&&(f+=edit),n.pageModel.delete&&(f+=remove),n.pageModel.customHandel)for(r=0;r<n.pageModel.customHandel.length;r++)f+='<i class="'+n.pageModel.customHandel[r].className+'"data-id="'+n.pageModel.customHandel[r].id+'"  data-custom="'+e+'">'+n.pageModel.customHandel[r].text+"<\/i>";i.jqGrid("setRowData",u[t],{act:f});o=i.getRowData(u[t]);n.definedRowclass&&o[n.definedRowclass.name]==n.definedRowclass.value&&$("#"+u[t]).addClass(n.definedRowclass.class)}},loadComplete:function(){$(t).find(".jq-grid *[data-edit]").click(function(){n.edit($(this).data("edit"))});$(t).find(".jq-grid *[data-del]").click(function(){n.del($(this).data("del"))});$(t).find(".jq-grid *[data-custom]").click(function(){var t=$(this).data("id"),r=$(this).data("custom"),u=i.jqGrid("getRowData",r),f=$.grep(n.pageModel.customHandel,function(n){return n.id==t});f[0].event(u)});i.setGridWidth($(t).width())},onSortCol:function(t,i,r){n.sort(t,r)},onSelectRow:function(t,r,u){var f=i.jqGrid("getRowData",t);console.log(f);u.which!=1||!n.pageModel.clickRow||n.pageModel.clickRow(f);n.pageModel.getSelected&&n.pageModel.getSelected(i.jqGrid("getGridParam","selarrrow"))},ondblClickRow:function(t){var r=i.jqGrid("getRowData",t);!n.pageModel.doubleClickRow||n.pageModel.doubleClickRow(r)},rowNum:100,rowList:[100],onSelectAll:function(){n.pageModel.getSelected&&n.pageModel.getSelected(i.jqGrid("getGridParam","selarrrow"))}})};n.load=function(){for(var r=0;r<n.columnConfig.length;r++)n.columnConfig[r].sortable||(n.columnConfig[r].sortable=!1),n.colNames.push(n.columnConfig[r].displayName);!n.pageModel.datas||(n.pageInit(),$(window).resize(function(){i.setGridWidth($(t).width())}),n.columnConfig[0].frozen&&(setTimeout(function(){i.jqGrid("setFrozenColumns")},3e3),$(t).find(".edit-bd").hide()))};n.load();n.colSelect=function(){for(var i,t=0;t<n.columnConfig.length;t++)i=$("td[aria-describedby='jqgrid_"+n.columnConfig[t].name+"'],#jqgrid_"+n.columnConfig[t].name),n.columnConfig[t].check?(i.show(),$(".jqgfirstrow td").eq(t).show()):(i.hide(),$(".jqgfirstrow td").eq(t).hide())};n.edit=function(t){var r=i.jqGrid("getRowData",t);n.pageModel.edit(r)};n.del=function(t){var r=i.jqGrid("getRowData",t);n.pageModel.delete(r)};n.setColShow=function(){n.setcol=!n.setcol};n.sort=function(t,i){n.pageModel.paging.orderByProperty=t;n.pageModel.paging.ascending=i=="asc"?!0:!1;n.pageModel.load()};n.$watch("pageModel.datas",function(){i.jqGrid("clearGridData");i.jqGrid("setGridParam",{data:n.pageModel.datas}).trigger("reloadGrid")})}}}]);_shared.directive("onFinishRender",function(n){return{restrict:"A",link:function(t){t.$last===!0&&n(function(){t.$emit("ngRepeatFinished")})}}});
...
/**** fm-datetime.js *****/
_shared.directive("fmDatetime",["fmTool","$timeout",function(n){return{restrict:"E",replace:!0,template:function(t,i){i.$ctrlType="fm-datetime";n.textInit(i);var r=n.setValidate(i);return i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1)),'<div fm-model="'+i.fmModel+'" title="{{getShadeText()}}" class="input-sm fm-text form-control" ng-class="state" ng-mousedown="event_textboxClick($event)"><input  type="datetime" date-time '+(!i.name?"":'name="'+i.name+'"')+" "+r.join(" ")+' placeholder="{{fmPlaceholder}}" class="fm-text-input validate" ng-blur="event_blur($event)" ng-readonly="state==\'readonly\'" ng-disabled="state==\'disabled\'" type="text"/><label class="fm-text-shadetext">{{ shadeText }}<\/label><div class="fm-text-tool"><i class="textbox_unit" ng-hide="!unit">{{unit}}<\/i><i class="fm-text-tool-clear icon-times" ng-hide="!iClear || state!=\'normal\'" ng-mousedown="clearText($event)"><\/i><\/div><\/div>'},scope:{fmModel:"=",unit:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",fmBlur:"&",fmChange:"&"},link:function(t,i,r){var u=i.find("input"),f;r.view=="hours"?u.datetimepicker({language:app.language,weekStart:0,todayBtn:0,autoclose:1,todayHighlight:1,startView:1,minView:0,maxView:1,forceParse:0,format:"hh:ii"}):r.view=="month"?u.datetimepicker({language:app.language,weekStart:1,todayBtn:1,autoclose:1,todayHighlight:1,startView:2,minView:2,maxView:1,forceParse:0,format:"yyyy-mm"}):r.view=="datetime"?u.datetimepicker({language:app.language,weekStart:1,todayBtn:1,autoclose:1,todayHighlight:1,startView:2,minView:0,maxView:1,forceParse:0,format:"yyyy-mm-dd hh:ii"}):u.datetimepicker({language:app.language,weekStart:1,todayBtn:1,autoclose:1,todayHighlight:1,startView:2,minView:2,forceParse:0,format:"yyyy-mm-dd"});u.on("changeDate",function(){return});f=$(u).data("datetimepicker");t.fmPlaceholder=r.fmPlaceholder;t.format=r.format;t.fieldName=r.fieldName;t.unit=t.unit||r.unit;t.iClear=t.iClear||r.iClear!=undefined&&r.iClear!="false"&&!0;!r.iClear||r.iClear=="false"||(t.iClear=!0);n.setScopeState(t,r);t.findText=function(n){return!t.fmModel||n.indexOf(t.fmModel)>=0?!0:!1};n.setDefaultWatch(r,t,i);t.event_blur=function(n){var i=$(n.target),u;if(r.view==="hours")try{/^(20|21|22|23|[0-1]?\d):[0-5]?\d$/.test(i.val())?t.fmModel=i.val():(i.val(""),t.fmModel="")}catch(f){i.val("")}else r.view==="date"&&(u=_$.newDate(i.val()),t.fmModel=u=="Invalid Date"?"":i.val());t.fmBlur()};t.$watch("fmModel",function(n){if(t.fmModel||(t.fmModel=""),t.fmModel==""){u.val(t.fmModel);t.shadeText=t.fmModel;return}var i=t.fmModel;r.view==="hours"?(i=n="2017-1-1 "+n,t.fmModel=_$.newDate(n).format("hh:mm")):t.fmModel=r.view==="month"?_$.newDate(n).format("yyyy-MM"):r.view==="datetime"?_$.newDate(n).format("yyyy-MM-dd hh:mm"):_$.newDate(n).format("yyyy-MM-dd");u.val(t.fmModel);t.shadeText=t.fmModel;f.setDate(_$.newDate(i))});t.clearText=function(){t.fmModel=""};$(i).find("input").on("change",function(){var i=$(this).val(),n={date:i};t.$apply(function(){t.fmModel=r.view==="hours"?_$.newDate(n.date).format("hh:mm"):r.view==="month"?_$.newDate(n.date).format("yyyy-MM"):r.view==="datetime"?_$.newDate(n.date).format("yyyy-MM-dd hh:mm"):_$.newDate(n.date).format("yyyy-MM-dd");t.shadeText=t.fmModel});t.$apply(function(){t.fmBlur();t.fmChange()})})}}}]);
/**** fm-job-select.js *****/
