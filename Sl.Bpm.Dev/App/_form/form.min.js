...
/**** fm-datetime.js *****/
_shared.directive("fmDatetime",["fmTool","$timeout",function(n){return{restrict:"E",replace:!0,template:function(t,i){i.$ctrlType="fm-datetime";n.textInit(i);var r=n.setValidate(i);return i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1)),'<div fm-model="'+i.fmModel+'" title="{{getShadeText()}}" class="input-sm fm-text form-control" ng-class="state" ng-mousedown="event_textboxClick($event)"><input '+(!i.name?"":'name="'+i.name+'"')+" "+r.join(" ")+' class="fm-text-input validate"  type="text"/><label class="fm-text-shadetext">{{ shadeText }}<\/label><div class="fm-text-tool"><i class="textbox_unit" ng-hide="!unit">{{unit}}<\/i><i class="fm-text-tool-clear icon-times" ng-hide="!iClear || state!=\'normal\'" ng-mousedown="clearText($event)"><\/i><\/div><\/div>'},scope:{fmModel:"=",unit:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",fmBlur:"&",fmChange:"&"},link:function(t,i,r){var u=i.find("input"),f;r.view=="hours"?u.datetimepicker({language:$currentUser.language,weekStart:0,todayBtn:0,autoclose:1,todayHighlight:1,startView:1,minView:0,maxView:1,forceParse:0,format:"hh:ii"}):r.view=="month"?(u.datetimepicker({language:$currentUser.language,weekStart:1,todayBtn:1,autoclose:1,todayHighlight:1,startView:3,minView:3,maxView:5,forceParse:0,format:"yyyy-mm"}),$(u).attr("readonly","readonly")):r.view=="datetime"?u.datetimepicker({language:$currentUser.language,weekStart:1,todayBtn:1,autoclose:1,todayHighlight:1,startView:2,minView:0,maxView:1,forceParse:0,format:"yyyy-mm-dd hh:ii"}):u.datetimepicker({language:$currentUser.language,weekStart:1,todayBtn:1,autoclose:1,todayHighlight:1,startView:2,minView:2,forceParse:0,format:"yyyy-mm-dd"});f=$(u).data("datetimepicker");t.fmPlaceholder=r.fmPlaceholder;t.format=r.format;t.fieldName=r.fieldName;t.unit=t.unit||r.unit;t.iClear=t.iClear||r.iClear!=undefined&&r.iClear!="false"&&!0;!r.iClear||r.iClear=="false"||(t.iClear=!0);n.setScopeState(t,r);t.findText=function(n){return!t.fmModel||n.indexOf(t.fmModel)>=0?!0:!1};n.setDefaultWatch(r,t,i);t.$watch("fmModel",function(n){t.shadeText=n;f.setDate(_$.newDate(n))});t.clearText=function(){t.fmModel=""};$(i).find("input").on("change blur",function(){var n=$(this).val();t.$apply(function(){switch(r.view){case"hours":t.fmModel=/^(20|21|22|23|[0-1]?\d):[0-5]?\d$/.test(n)?n:"";break;case"month":t.fmModel=n;break;default:var i=_$.newDate(n);t.fmModel=i=="Invalid Date"?"":i.format("yyyy-MM-dd")}});$(this).val(t.fmModel);t.$apply(function(){t.fmBlur();t.fmChange()})})}}}]);
/**** fm-job-select.js *****/
