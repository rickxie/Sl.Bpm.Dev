...
/**** fm-editor.js *****/
_shared.directive("fmEditor",["$timeout",function(n){return{restrict:"E",replace:!0,template:function(n,t){t.guid="editor_"+_$.getGUID();var i=t.fmHeight||360;return'<div fm-model="'+t.fmModel+'" ><script type="text/plain" id="'+t.guid+'" style="height:'+i+'px;width:100%"><\/script ><\/div>'},scope:{fmModel:"=",fmDisabled:"=",fmReadonly:"=",fmBlur:"&",fmHeight:"="},link:function(t,i,r){n(function(){$("#"+r.guid).html(t.fmModel);var n=UM.getEditor(r.guid,{elementPathEnabled:!0});n.addListener("contentChange",function(){t.fmModel=n.getContent();t.$apply()})})}}}]);
/**** fm-job-select.js *****/
