...
/**** fm-grid.js *****/
_shared.directive("fmGrid",["mabp.app.module","mabp.app.file","fmTool","$timeout",function(){return{restrict:"E",replace:!0,template:function(n,t){return t.guid=_$.getGUID(),'<div class="jq-grid-bd"><table id="jqgrid'+t.guid+'" class="jq-grid" ><\/table><div class="table-footer"><div class="edit-bd" > <input type = "BUTTON" ng-click="setColShow()" value = "选择列" /> <div class="set-cols"><ul ng-show="setcol"><li style = "text-align: right;line-height: 20px;" > <i class="icon-remove-sign" style="cursor: pointer" ng-click="setColShow()"><\/i><\/li> <li ng-repeat="m in columnConfig" ng-hide="m.name==\'_$rownumber\' || m.frozen"><input type="checkbox" ng-init="m.check=m.hidden==true?false:true" ng-click="colSelect(m)" ng-model="m.check" />{{ m.displayName }}<\/li><\/ul><\/div> <\/div>  <div class="table-footer-pager" ng-if="pageModel.paging.totalCount > 0"> <rs-pager  current-page="pageModel.paging.currentPage" load="pageModel.load()" total-count="pageModel.paging.totalCount" page-size="pageModel.paging.pageSize"><\/rs-pager><\/div> <\/div><\/div>'},scope:{columnConfig:"=",pageModel:"=",rowHandel:"=",height:"=",definedRowclass:"=",multiselect:"="},link:function(n,t){var i=$(t).find(".jq-grid"),r=n.pageModel.datas;n.colNames=[];n.pageInit=function(){i.jqGrid({data:n.pageModel.datas,datatype:"local",colNames:n.colNames,colModel:n.columnConfig,rowNum:n.pageModel.paging.pageSize,rowList:[10,20,30],height:n.height||400,multiselect:n.multiselect||!1,multiselectWidth:38,gridComplete:function(){for(var u,t,e,f=i.jqGrid("getDataIDs"),r=0;r<n.pageModel.datas.length;r++){if(u="",edit='<i title="编辑" class="icon-edit grid-btn ed"  data-edit="'+r+'"><\/i>',remove='<i title="删除" class="icon-remove-sign grid-btn ed"  data-del="'+r+'"><\/i>',n.pageModel.edit&&(u+=edit),n.pageModel.delete&&(u+=remove),n.pageModel.customHandel)for(t=0;t<n.pageModel.customHandel.length;t++)(!n.pageModel.customHandel[t].isShow||n.pageModel.customHandel[t].isShow(n.pageModel.datas[r]))&&(u+='<i title="'+(n.pageModel.customHandel[t].title||n.pageModel.customHandel[t].text||"")+'" class="grid-btn '+(n.pageModel.customHandel[t].className||"")+'"data-id="'+t+'"  data-custom="'+r+'">'+(n.pageModel.customHandel[t].text||"")+"<\/i>");i.jqGrid("setRowData",f[r],{act:u});e=n.pageModel.datas[r];n.definedRowclass&&e[n.definedRowclass.name]==n.definedRowclass.value&&i.find("#"+f[r]).addClass(n.definedRowclass.class)}},loadComplete:function(){$(t).find(".jq-grid *[data-edit]").click(function(t){n.edit($(this).data("edit"));t.stopPropagation()});$(t).find(".jq-grid *[data-del]").click(function(t){n.del($(this).data("del"));t.stopPropagation()});$(t).find(".jq-grid *[data-custom]").click(function(t){var i=$(this).data("id"),r=$(this).data("custom");n.pageModel.customHandel[i].event(n.pageModel.datas[r]);t.stopPropagation()});i.setGridWidth($(t).width());n.ChangeColumnWidth&&n.ChangeColumnWidth()},onSortCol:function(t,i,r){n.sort(t,r)},onSelectRow:function(t,r,u){var f=n.pageModel.datas[i.find("#"+t)[0].rowIndex-1];u.which!=1||!n.pageModel.clickRow||n.pageModel.clickRow(f);n.pageModel.getSelected&&n.pageModel.getSelected(i.jqGrid("getGridParam","selarrrow"))},ondblClickRow:function(t){var r=n.pageModel.datas[i.find("#"+t)[0].rowIndex-1];!n.pageModel.doubleClickRow||n.pageModel.doubleClickRow(r)},rowNum:100,rowList:[100],onSelectAll:function(){n.pageModel.getSelected&&n.pageModel.getSelected(i.jqGrid("getGridParam","selarrrow"))},beforeSelectRow:function(n,t){var u=$(this),i=$.jgrid.getCellIndex($(t.target).closest("td")[0]),r=u.jqGrid("getGridParam","colModel");return r[i].name==="cb"||r[i].name==="no"}})};n.dateFmt=function(){for(var i,r,t=0;t<n.columnConfig.length;t++)if(!!n.columnConfig[t].datefmt)for(i=0;i<n.pageModel.datas.length;i++)r=n.pageModel.datas[i][n.columnConfig[t].name],!r||(n.pageModel.datas[i][n.columnConfig[t].name]=new Date(r.replace(new RegExp(/-/gm),"/")).format(n.columnConfig[t].datefmt))};n.load=function(){for(var r=0;r<n.columnConfig.length;r++)n.columnConfig[r].sortable||(n.columnConfig[r].sortable=!1),n.columnConfig[r].key=!1,n.colNames.push(n.columnConfig[r].displayName);!n.pageModel.datas||(n.pageInit(),$(window).resize(function(){i.setGridWidth($(t).width());n.ChangeColumnWidth()}),n.columnConfig[0].frozen&&setTimeout(function(){i.jqGrid("setFrozenColumns")},3e3))};n.load();n.colSelect=function(){for(var r=0;r<n.columnConfig.length;r++)n.columnConfig[r].name!="_$rownumber"&&(n.columnConfig[r].check?i.jqGrid("showCol",n.columnConfig[r].name):i.jqGrid("hideCol",n.columnConfig[r].name));i.setGridWidth($(t).width());n.ChangeColumnWidth()};n.edit=function(t){n.pageModel.edit($.extend({},n.pageModel.datas[t]))};n.del=function(t){n.pageModel.delete(n.pageModel.datas[t])};n.setColShow=function(){n.setcol=!n.setcol};n.ChangeColumnWidth=function(){for(var u,r,i=0;i<n.columnConfig.length;i++)u=n.columnConfig[i].colWidth,r=n.multiselect==!0?i+1:i,u?($(t).find(".ui-jqgrid-labels th").eq(r).width(u),$(t).find(".jqgfirstrow td").eq(r).width(u)):n.columnConfig[i].width||($(t).find(".ui-jqgrid-labels th").eq(r).css("width","auto"),$(t).find(".jqgfirstrow td").eq(r).css("width","auto")),n.multiselect&&$(t).find(".ui-jqgrid-labels th").eq(0).css({"text-align":"center","text-indent":"0"});$(t).find(".ui-jqgrid-htable tr th").each(function(){if($(this)[0].scrollWidth>$(this).outerWidth()){var n=$(this)[0].scrollWidth;$(this).width(n);$(t).find(".jqgfirstrow td").eq($(this).index()).width(n)}});$(t).find(".frozen-div th").each(function(){var n=$(t).find(".ui-jqgrid-hbox th").eq($(this).index()).width();$(this).width(n);$(t).find(".frozen-bdiv .jqgfirstrow td").eq($(this).index()).width(n)})};n.sort=function(t,i){n.pageModel.paging.orderByProperty=t;n.pageModel.paging.ascending=i=="asc"?!0:!1;n.pageModel.load()};n.$watch("pageModel.datas",function(){n.dateFmt();i.jqGrid("clearGridData");i.jqGrid("setGridParam",{data:n.pageModel.datas}).trigger("reloadGrid")})}}}]);
...
/**** fm-datetime.js *****/
_shared.directive("fmDatetime",["fmTool","$timeout",function(n){return{restrict:"E",replace:!0,template:function(t,i){i.$ctrlType="fm-datetime";n.textInit(i);var r=n.setValidate(i);return i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1)),'<div fm-model="'+i.fmModel+'" title="{{getShadeText()}}" class="input-sm fm-text form-control" ng-class="state" ng-mousedown="event_textboxClick($event)"><input '+(!i.name?"":'name="'+i.name+'"')+" "+r.join(" ")+' class="fm-text-input validate"  type="text"  autocomplete="off"/><label class="fm-text-shadetext">{{ shadeText }}<\/label><div class="fm-text-tool"><i class="textbox_unit" ng-hide="!unit">{{unit}}<\/i><i class="fm-text-tool-clear icon-times" ng-hide="!iClear || state!=\'normal\'" ng-mousedown="clearText($event)"><\/i><\/div><\/div>'},scope:{fmModel:"=",unit:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",startDate:"=",endDate:"=",fmBlur:"&",fmChange:"&"},link:function(t,i,r){function e(n){var i,t;(n===null||n===undefined)&&(n="");i="";switch(r.view){case"hours":/^(20|21|22|23|[0-1]?\d):[0-5]?\d$/.test(n)?i=n:(t=_$.newDate(n),t!="Invalid Date"&&(i=t.format("hh:mm")));break;case"datetime":t=_$.newDate(n);t!="Invalid Date"&&(i=t.format("yyyy-MM-dd hh:mm"));break;case"month":i=n;break;default:t=_$.newDate(n);t!="Invalid Date"&&(i=t.format("yyyy-MM-dd"))}return i}var u=i.find("input"),f=window.$currentUser&&$currentUser.language||"zh-CN",o;if(r.view=="hours")u.datetimepicker({language:f,weekStart:0,todayBtn:0,autoclose:1,todayHighlight:1,startView:1,minView:0,maxView:1,forceParse:0,format:"hh:ii"}).on("hide",function(){t.fmBlur()});else if(r.view=="month"){u.datetimepicker({language:f,weekStart:1,todayBtn:1,autoclose:1,todayHighlight:1,startView:3,minView:3,maxView:5,forceParse:0,format:"yyyy-mm"}).on("hide",function(){t.fmBlur()});$(u).attr("readonly","readonly")}else if(r.view=="datetime")u.datetimepicker({language:f,weekStart:1,todayBtn:1,autoclose:1,todayHighlight:1,startView:2,minView:0,maxView:5,forceParse:0,format:"yyyy-mm-dd hh:ii"}).on("hide",function(){t.fmBlur()});else u.datetimepicker({language:f,weekStart:1,todayBtn:1,autoclose:1,todayHighlight:1,startView:2,minView:2,forceParse:0,format:"yyyy-mm-dd"}).on("hide",function(){t.fmBlur()});o=$(u).data("datetimepicker");t.fmPlaceholder=r.fmPlaceholder;t.format=r.format;t.fieldName=r.fieldName;t.unit=t.unit||r.unit;t.iClear=t.iClear||r.iClear!=undefined&&r.iClear!="false"&&!0;!r.iClear||r.iClear=="false"||(t.iClear=!0);n.setScopeState(t,r);t.findText=function(n){return!t.fmModel||n.indexOf(t.fmModel)>=0?!0:!1};n.setDefaultWatch(r,t,i);t.clearText=function(){t.fmModel=""};t.$watch("fmModel",function(n){var r=e(n);t.shadeText=r;$(i).find("input").val(r)});t.$watch("startDate",function(n){n&&$(i).find("input").datetimepicker("setStartDate",n)});t.$watch("endDate",function(n){n&&$(i).find("input").datetimepicker("setEndDate",n)});$(i).find("input").on("change blur",function(n){t.fmModel=$(this).val();t.$apply();switch(n.type){case"change":t.fmChange()}t.$apply()}).val(e(t.fmModel)).datetimepicker("update")}}}]);
/**** fm-editor.js *****/
_shared.directive("fmEditor",["$timeout","fmTool",function(n,t){return{restrict:"E",replace:!0,template:function(n,t){t.guid="editor_"+_$.getGUID();var i=t.fmHeight||360;return'<div class="fm-editor" ng-class="state" ng-readonly="state==\'readonly\'" ng-disabled="state==\'disabled\'" fm-model="'+t.fmModel+'" ><script type="text/plain" id="'+t.guid+'" style="height:'+i+'px;width:100%" ><\/script><div ng-if="state==\'readonly\'" style="border-bottom: 1px dashed #d5d5d5;" ng-bind-html="fmModel"><\/div><\/div> '},scope:{fmModel:"=",fmDisabled:"=",fmReadonly:"=",fmBlur:"&",fmHeight:"=",fmDisabled:"=",fmReadonly:"="},link:function(i,r,u){t.setScopeState(i,u);t.setDefaultWatch(u,i,r);var f=u.fmPlaceholder==undefined?"":'<p style="color:#999">'+u.fmPlaceholder+"<\/p>";n(function(){var n=UM.getEditor(u.guid,{elementPathEnabled:!0}),t=!1,r=!1;n.addListener("contentChange",function(){if(t==!0){t=!1;return}i.fmModel=n.getContent();r=!0;i.$apply()});n.addListener("focus",function(){!f||n.getContent()!=f||n.setContent("")});n.addListener("blur",function(){!f||n.getContent()!=""||n.setContent(f)});i.state=="disabled"&&n.setDisabled();i.state=="readonly"&&n.setHide();i.$watch("fmModel",function(i){if(r==!0){r=!1;return}t=!0;n.setContent(i||f||"")})})}}}]);
/**** fm-job-select.js *****/
...
/**** fm-uploader.js *****/
_shared.directive("fmUploader",["fmTool","$compile","FileUploader","mabp.app.file","appSession",function(n,t,i,r,u){return{restrict:"E",replace:!0,template:function(){return'<span><input type="file" class="picUpload" nv-file-select uploader="uploader" multiple="true" accept="{{accept}}"/><input type="button" class="btn btn-sm btn-info ng-scope" ng-click="event_upload()" value="{{btnname}}" /><\/span>'},scope:{callbackFunc:"&",filters:"@"},compile:function(){return{pre:function(t,r,u){n.setDefaultWatch(u,t,r);t.fieldName=u.fieldName;t.uploader=new i({url:"/fileApi/File/UploadFiles"});t.getFileIcon=function(n){t.fileType=n.extensionName.toLowerCase().substring(1);switch(n.extensionName.toLowerCase().substring(1)){case"png":case"jpg":case"bmp":case"gif":case"jpeg":return"icon-file-image";case"txt":case"xml":case"json":case"config":return"icon-file-text-o";case"doc":case"docx":return"icon-file-word";case"xls":case"xlsx":return"icon-file-excel";case"ppt":case"pptx":return"icon-file-powerpoint";case"mp3":case"wav":case"mid":return"icon-file-audio";case"mp4":case"avi":case"wmv":case"flv":case"rmvb":return"icon-file-movie";case"js":case"cs":case"css":case"c":case"java":case"sql":return"icon-file-code";case"pdf":case"fdf":case"xdp":return"icon-file-pdf";case"zip":case"rar":case"cab":case"7z":return"icon-file-archive";default:return"icon-file-o"}}},post:function(n,t,i){if(n.btnname=i.buttonName||"上传附件",n.userId=u.userId,n.accept="*",n.filters){var f=n.filters.toLowerCase().replace(/\s/g,"").split("|"),r=[];angular.forEach(f,function(n){r.push("."+n)});n.accept=r.join(",")}n.event_upload=function(){$(t).find(".picUpload").click()};n.uploader.filters.push({name:"customFilter",fn:function(n){var i=n.size,t=i<52428800;return t||mabp.notify.warn("附件应小于50MB"),t}});n.uploader.filters.push({name:"controllerFilter",fn:function(t){if(n.filters){var i=(/(?:\.([^.]+))?$/.exec(t.name)[1]||"").toLowerCase(),r=n.filters.toLowerCase().replace(/\s/g,"").split("|"),u={};return(angular.forEach(r,function(n){u[n]=!0}),!u[i])?(mabp.notify.warn(L("Fileuploads")+"<b>"+i+"<\/b> "+L("Notsupported")+L("Onlysupport")+"<b>"+r.join(" , ")+"<\/b>"),!1):!0}return!0}});n.uploader.onAfterAddingFile=function(){n.uploader.getNotUploadedItems().length&&n.uploader.uploadAll()};n.uploader.onSuccessItem=function(t,i){var e=i.isSuccess,f,r;if(e)for(f=0;f<i.result.length;f++)r=i.result[f],r.creationTime=(new Date).format("yyyy-MM-dd hh:mm"),r.userName=u.userName,r.creatorUserId=u.userId,n.callbackFunc({selectItem:r})};n.uploader.onErrorItem=function(){n.uploader.queue[n.uploader.queue.length-1].remove();console.log("附件上传失败");mabp.notify.warn("附件上传失败")}}}}}}]);
/**** fm-applicant.js *****/
