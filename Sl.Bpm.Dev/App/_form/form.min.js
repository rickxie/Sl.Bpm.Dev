...
/**** fm-uploader.js *****/
_shared.directive("fmUploader",["fmTool","$compile","FileUploader","mabp.app.file","appSession",function(n,t,i,r,u){return{restrict:"E",replace:!0,template:function(){return'<span><input type="file" class="picUpload" nv-file-select uploader="uploader" multiple="true" accept="{{accept}}"/><input type="button" class="btn btn-sm btn-info ng-scope" ng-click="event_upload()" value="{{btnname}}" /><\/span>'},scope:{callbackFunc:"&",filters:"@"},compile:function(){return{pre:function(t,r,u){n.setDefaultWatch(u,t,r);t.fieldName=u.fieldName;t.uploader=new i({url:"/fileApi/File/UploadFiles"});t.getFileIcon=function(n){t.fileType=n.extensionName.toLowerCase().substring(1);switch(n.extensionName.toLowerCase().substring(1)){case"png":case"jpg":case"bmp":case"gif":case"jpeg":return"icon-file-image";case"txt":case"xml":case"json":case"config":return"icon-file-text-o";case"doc":case"docx":return"icon-file-word";case"xls":case"xlsx":return"icon-file-excel";case"ppt":case"pptx":return"icon-file-powerpoint";case"mp3":case"wav":case"mid":return"icon-file-audio";case"mp4":case"avi":case"wmv":case"flv":case"rmvb":return"icon-file-movie";case"js":case"cs":case"css":case"c":case"java":case"sql":return"icon-file-code";case"pdf":case"fdf":case"xdp":return"icon-file-pdf";case"zip":case"rar":case"cab":case"7z":return"icon-file-archive";default:return"icon-file-o"}}},post:function(t,i,r){if(t.btnname=r.buttonName||"上传附件",t.userId=u.userId,r.pageState=$(".fm-content").attr("page-state"),n.setScopeState(t,r),t.accept="*",t.filters){var e=t.filters.toLowerCase().replace(/\s/g,"").split("|"),f=[];angular.forEach(e,function(n){f.push("."+n)});t.accept=f.join(",")}t.event_upload=function(){$(i).find(".picUpload").click()};t.uploader.filters.push({name:"customFilter",fn:function(n){var i=n.size,t=i<52428800;return t||mabp.notify.warn("附件应小于50MB"),t}});t.uploader.filters.push({name:"controllerFilter",fn:function(n){if(t.filters){var i=(/(?:\.([^.]+))?$/.exec(n.name)[1]||"").toLowerCase(),r=t.filters.toLowerCase().replace(/\s/g,"").split("|"),u={};return(angular.forEach(r,function(n){u[n]=!0}),!u[i])?(mabp.notify.warn(L("Fileuploads")+"<b>"+i+"<\/b> "+L("Notsupported")+L("Onlysupport")+"<b>"+r.join(" , ")+"<\/b>"),!1):!0}return!0}});t.uploader.onAfterAddingFile=function(){t.uploader.getNotUploadedItems().length&&t.uploader.uploadAll()};t.uploader.onSuccessItem=function(n,i){var e=i.isSuccess,f,r;if(e)for(f=0;f<i.result.length;f++)r=i.result[f],r.creationTime=(new Date).format("yyyy-MM-dd hh:mm"),r.userName=u.userName,r.creatorUserId=u.userId,t.state=="normal"&&t.callbackFunc({selectItem:r})};t.uploader.onErrorItem=function(){t.uploader.queue[t.uploader.queue.length-1].remove();console.log("附件上传失败");mabp.notify.warn("附件上传失败")}}}}}}]);
/**** fm-applicant.js *****/
