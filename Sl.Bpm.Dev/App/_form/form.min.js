...
/**** fm-editor.js *****/
_shared.directive("fmEditor",["$timeout",function(){return{restrict:"E",replace:!0,template:function(n,t){return'<div fm-model="'+t.fmModel+'" ><\/div>'},scope:{fmModel:"=",fmDisabled:"=",fmReadonly:"=",fmBlur:"&"},link:function(n,t){$(t).html('<script type="text/plain" id="myEditor" style="width:1000px;height:240px;">'+n.fmModel+"<\/script >");var i=UM.getEditor("myEditor");i.addListener("contentChange",function(){n.fmModel=i.getContent();n.$apply()})}}}]);
/**** fm-job-select.js *****/
