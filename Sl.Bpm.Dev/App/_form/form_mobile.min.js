...
/**** fm-table.js *****/
_shared.directive("fmTable",["mabp.app.module","mabp.app.file","fmTool","$timeout",function(n,t,i,r){return{restrict:"E",replace:!0,template:function(){return'<div><div class="col-xs-12"><button class="btn btn-info btn-sm" ng-if="allColumnFilter && hasSearch" ng-click="show()">'+L("QueryCriteria")+'<\/button><\/div><div class="panel-heading" ng-if="!!show1 && !!allColumnFilter && !!displayColumListAll"><div class="row search-condition"><div class="col-xs-3" ng-repeat="col in displayColumListAll" ng-show="col.isWhereEnable"><div class="input-group" style="margin-bottom:5px;"><span class="input-group-addon input-sm">{{col.name}}<\/span><input name="{{col.displayColumn}}" type="text" class="form-control input-sm" placeholder="" ng-enter="filterData()" /><\/div><\/div><\/div><div class="row"><div class="col-xs-6"><input type="button" value="'+L("Search")+'" class="btn btn-block btn-info btn-md" style="padding: 1px 5px;" ng-click="filterData()" /><\/div><div class="col-xs-6"><input type="button" value="'+L("Clear")+'" class="btn btn-block btn-default btn-md" style="padding: 1px 5px;" ng-click="clearCondition()" /><\/div><\/div><\/div><div id="{{guid}}" class="col-xs-12" style="height:380px;width:100%;"><\/div><div class="row"><div class=" col-xs-12"><div class="col-xs-4" style="text-align:left;" ><button id="{{item.id}}" ng-if="item.enable" ng-repeat="item in actionButtons | orderBy : \'displayOrder\'" class="btn btn-info btn-sm" ng-click="item.action(selectItems)" style="margin:0 3px;">{{item.text}}<\/button><\/div><div ng-if="pageSizeList && (isExcel || isMergeExcel)" class="col-xs-2">&nbsp;<\/div><ma-pager load="load(true)" current-page="paging.currentPage" total-count="paging.totalCount" page-size="paging.pageSize"><\/list-pager><\/div><\/div><\/div>'},scope:{view:"=",data:"=",filter:"=",refreshData:"=",selectItems:"=",guid:"=",currentPageData:"=",excel:"&",sumColumns:"=",zip:"&",addButtons:"=",colConfig:"="},link:function(i,u,f){i.moduleId=i.$parent!=null&&i.$parent.base!=null?i.$parent.base.moduleId:null;i.language=mabp.language;i.showPages=[];i.currentPageIndex=0;i.currentPageData=[];i.pageNum=0;i.pageSize=10;i.selectItems=[];i.refresh=!1;i.guid=_$.getGUID(!0);i.column=[];i.columnText=[];i.isExcel=null;i.isMergeExcel=null;i.zip=!1;i.page=null;i.paging={};i.paging.totalCount=0;i.checkbox=!1;i.radiobox=!1;i.sortable=!1;i.pageSizeList=null;i.isAllChecked=!1;i.allColumnFilter=!0;i.pdf=!1;i.show1=!1;(i.excel||f.excel!==undefined)&&(i.isExcel=!0);f.enableMerge===""&&(i.isMergeExcel=!0);(i.zip||f.zip!==undefined)&&(i.zip=!0);f.fixHeaderRow===""&&(i.fixedHeaderRow=!0);f.singleRowSelect===""&&(i.singleRowSelect=!0);f.checkedByRow===""&&(i.checkedByRow=!0);(i.page||f.page!==undefined)&&(i.page=!0,!f.page||(i.paging=JSON.parse(f.page),i.paging.totalCount=1,i.toPage=i.paging.currentPage));f.checkable==""&&(i.checkbox=!0);f.radiobox==""&&(i.radiobox=!0);f.sortable==""&&(i.sortable=!0);f.pageSizeList!==undefined&&(i.pageSizeList=[10,20,50,100]);f.pdf!=""&&!f.pdfLanguages||(i.pdf=!0);var e=_$.getGUID(!0),o=_$.getGUID(!0),s=_$.getGUID(!0);i.actionButtons=[{id:e,text:mabp.L("Export"),action:function(){i.exportExcel(e)},enable:i.isExcel||i.isMergeExcel,displayOrder:1},{id:o,text:mabp.L("Attachment"),action:function(){i.exportZip(o)},enable:i.zip,displayOrder:2},{id:s,text:"PDF",action:function(){i.exportPdf(s)},enable:i.pdf,displayOrder:3}];i.$watch("addButtons",function(){_.filter(i.addButtons,function(n){i.actionButtons.push(n)})},!0);i.load=function(t){!f.view||(i.condition(),i.page?n.getViewTable({code:f.view,filters:mabp.toArray(i.filter),allColumnFilter:!0,tableFilters:mabp.toArray(i.tableFilters),pageInput:i.paging,permissionKey:i.moduleId}).then(function(n){var o=_.map(n.displayColumList,function(n){return{name:_.camelCase(n.displayColumn),text:n.name,visible:n.isDisplayEnable}}),s,h;i.colConfig!=null&&(s=i.colConfig["*"]||{},_.forEach(o,function(n){var u=i.colConfig[n.name],t=angular.extend(s,u);for(var r in t)t.hasOwnProperty(r)&&(n[r]=t[r])}));var c=n.viewTable,e=new mcGrid,u={checkable:i.checkbox,sortable:i.sortable,isSingleRowSelected:i.singleRowSelect,isCheckedByRow:i.checkedByRow,width:f.width,orderBy:i.paging.orderByProperty,ascending:i.paging.ascending};i.isMergeExcel&&(u.mergeColumnMainIndex=f.mergeNum|0,u.mergeColumns=f.mergeColumns!=null&&f.mergeColumns.split(","));i.fixedHeaderRow&&(u.fixHeaderRow=!0,u.fixColumnNum=f.fixColumnNum);e.InitGrid(i.guid,u,o,c);h=/^\d{4}-\d{2}-\d{2}[T]([01]?\d|2[0-3]):[0-5]?\d:[0-5]?\d.\d?\d?\d?$/;e.on("TdInitialize",function(n){n.dom.addClass(n.col.name);n.dom.id=n.row.id;h.test(n.dom.innerHTML)&&(n.dom.innerHTML=moment(n.dom.innerHTML).format("YYYY-MM-DD"))});e.on("SortChanged",function(n){i.paging.orderByProperty=n.orderBy;i.paging.ascending=n.ascending;i.load(!0)});e.on("RowChecked",function(n){i.selectItems=n;i.$apply()});i.hasSearch=_.some(n.displayColumListAll,{isWhereEnable:!0});r(function(){i.currentPageData=n.viewTable;i.data=n.viewTable;i.paging.totalCount=n.totalCount});t||(i.displayColumListAll=n.displayColumListAll)}):n.getViewTable({code:f.view,filters:mabp.toArray(i.filter),permissionKey:i.moduleId}).then(function(n){!n||(i.hasSearch=_.some(n.displayColumListAll,{isWhereEnable:!0}),i.paging.totalCount=n.totalCount)}))};i.changePageSize=function(){i.pageSize=i.paging.pageSize;i.load(!0)};i.sort=function(n,t,r){i.paging.orderByProperty=i.column[t];i.paging.ascending=r;i.load(!0)};i.$watch("refreshData",function(n,t){n!==t&&(i.paging.currentPage=1,i.filterData())},!0);i.exportExcel=function(n){var u=new mabp.ui.executor(n," 导出中..."),r;u.start();r={};i.page?(i.pagingExport={},i.pagingExport.pageSize=2147483647,i.pagingExport.currentPage=1,i.pagingExport.orderByProperty=i.paging.orderByProperty,i.pagingExport.ascending=i.paging.ascending,r={code:f.view,filters:mabp.toArray(i.filter),allColumnFilter:!0,tableFilters:mabp.toArray(i.tableFilters),pageInput:i.pagingExport,fileNamePrefix:i.$parent.base.title}):r={code:f.view,filters:mabp.toArray(i.filter),allColumnFilter:!0,tableFilters:mabp.toArray(i.tableFilters),pageInput:{pageSize:2147483647,currentPage:1,orderByProperty:"Id",ascending:!0},fileNamePrefix:i.$parent.base.title};f.excel===""&&t.downloadView(r,{responseType:"blob"}).then(function(){u.stop()});f.mergeExcel===""&&((f.mergeColumns==null||f.sumColumns==null||f.mergeNum==null)&&console.error("检查merge-columns (如 1,2,3,4 ), merge-num(如: 0 ) 是否未配置全。"),r.value=JSON.stringify(r),r.mergeColumns=f.mergeColumns,r.sumColumns=f.sumColumns,r.mergeNum=f.mergeNum|0,t.downloadMergeExcel(r,{responseType:"blob"}).then(function(){u.stop()}))};i.exportZip=function(n){var r=new mabp.ui.executor(n," 制作中...");r.start();t.zip(JSON.stringify(i.selectItems),{responseType:"blob"}).then(function(){r.stop()})};i.exportPdf=function(n){var u=new mabp.ui.executor(n," 制作中..."),r;if(u.start(),!!i.selectItems){if(r=[],_.forEach(i.selectItems,function(n){var t={sn:n.snNumber,fileName:n.snNumber+" "+(n.areaCode||""),sourceText:1,sourceIdentity:"",operationType:1,targetType:2,displayLanguages:f.pdfLanguages,param:f.param};r.push(t)}),r.length==0){mabp.notify.info("请先选择一行数据");u.stop();return}t.insertJobConvertQueueAndUserFile(JSON.stringify(r)).then(function(){mabp.message.info("已经排队制作,请到 [我的]>[文件]菜单中下载 [批量PDF]","确认");u.stop()})}};i.filterData=function(){i.page?i.filterPaged():i.filterUnPaged()};i.filterPaged=function(){i.load(!0)};i.filterUnPaged=function(){for(var t,f,e,s,r={},u=document.querySelectorAll(".search-condition [name]"),n=0;n<u.length;n++)!u[n].value||(r[u[n].getAttribute("name")]=u[n].value);if(t=[],f=!0,Object.keys(r).length>0)for(n=0;n<i.data.length;n++){f=!0;for(e in r)if(s=e.lowerFirst(),(""+(angular.lowercase(i.data[n][s])||"")).indexOf(angular.lowercase(r[e]))<0){f=!1;break}f&&t.push(i.table[n])}else for(n=0;n<i.data.length;n++)t.push($.extend({},i.table[n]));for(i.pageNum=parseInt(t.length/i.pageSize),(t.length%i.pageSize!=0&&t.length>i.pageSize||i.pageNum===0)&&i.pageNum++,i.showPages=[],n=0;n<=i.pageNum-1;n++)n>=i.currentPageIndex-2&&n<=i.currentPageIndex+2&&i.showPages.push({index:n});var h=[],c=i.currentPageIndex*i.pageSize,o=i.currentPageIndex*i.pageSize+i.pageSize;for(o>t.length&&(o=t.length),n=c;n<o;n++)h.push(t[n]);i.currentPageData=h};i.condition=function(){for(var r={},t=document.querySelectorAll(".search-condition [name]"),n=0;n<t.length;n++)!t[n].value||(r[t[n].getAttribute("name")]=t[n].value);i.tableFilters=r};i.show=function(){i.show1=!i.show1};i.clearCondition=function(){for(var t=document.querySelectorAll(".search-condition [name]"),n=0;n<t.length;n++)t[n].value="";i.page?i.filterPaged():i.filterUnPaged()};i.load()}}}]);
/**** fm-tree-menu.js *****/
...
/**** fm-attachment.js *****/
_shared.directive("fmAttachment",["fmTool","$compile","FileUploader","mabp.app.file","appSession","formHelper",function(n,t,i,r,u,f){return{restrict:"E",replace:!0,template:function(t,i){var r=n.setValidate(i);return'<table field-name="{{fieldName}}" '+r.join(" ")+' class="fm-attachment table table-condensed" ng-class="state"><tbody><tr ng-repeat="item in uploader.queue"><td><img src="/Content/Images/load.gif" class="fileIcon" style="width:2rem;height:2rem;margin-right:1rem;"/><i class="fileRemoveIcon icon-times" ng-click="cacelFileItemUpload(item)" style="margin-right:0.5rem"><\/i><i class="fileIcon {{getFileIcon(item._file.name)}}"><\/i><a style="font-style:normal;word-break:break-all;">{{item._file.name}}<\/a><i class="file-upload-date">{{item.creationTime | date:"yyyy-MM-dd hh:mm"}}<\/i><\/td><\/tr><tr ng-repeat="item in files"><td><percent-display ng-if="item.isDownloading" ng-click="abortDownloadingFile(item)" side=40 percent="item.progress" numberColor="#3464b6" bgColor="#999" progressColor="#3464b6" style="top:-0.3rem;margin:0 0.2rem 1rem 0;"><\/percent-display><i ng-if="state==\'normal\' && (nodeId == item.nodeId || item.isDraft) && userId == item.creatorUserId"class="fileRemoveIcon icon-times"style="margin-right:1rem;" ng-click="event_delete(item);"><\/i><i class="fileIcon {{getFileIcon(item)}}" style="margin-right:1rem"><\/i><a target="_blank" style="word-break:break-all;" ng-click="downloadFile(item)">{{item.fileName}}<\/a><i class="file-upload-date">{{item.creationTime | date:"yyyy-MM-dd HH:mm"}}<\/i><i class="file-upload-username">{{item.userName}}<\/i><\/td><\/tr><\/tbody><tfoot ng-if="state==\'normal\'"><tr><td colspan="1"><input type="file" class="picUpload hidden" nv-file-select uploader="uploader" single accept="*" /><button type="button" class="button" ng-click="event_upload()" ng-bind="btnname" ><\/button><\/td><\/tr><\/tfoot><\/table>'},scope:{files:"=",fmModel:"=",taskId:"=",uploader:"=",getFileIcon:"&",linkId:"=",bpmFiles:"=",userId:"=",nodeId:"=",draftId:"=",formFiles:"=",fmRequired:"=",fmDisabled:"=",fmNormal:"=",callbackFunc:"&",filters:"@"},compile:function(){return{pre:function(t,r,u){n.setDefaultWatch(u,t,r);t.fieldName=u.fieldName;t.uploader=new i({url:"/fileApi/File/UploadFiles"});t.getFileIcon=function(n){t.fileType=n.extensionName&&n.extensionName.toLowerCase().substring(1);typeof n=="string"&&n.lastIndexOf(".")!=-1&&(t.fileType=n.substr(n.lastIndexOf(".")+1));switch(t.fileType){case"png":case"jpg":case"bmp":case"gif":case"jpeg":return"icon-file-image";case"txt":case"xml":case"json":case"config":return"icon-file-text-o";case"doc":case"docx":return"icon-file-word";case"xls":case"xlsx":return"icon-file-excel";case"ppt":case"pptx":return"icon-file-powerpoint";case"mp3":case"wav":case"mid":return"icon-file-audio";case"mp4":case"avi":case"wmv":case"flv":case"rmvb":return"icon-file-movie";case"js":case"cs":case"css":case"c":case"java":case"sql":return"icon-file-code";case"pdf":case"fdf":case"xdp":return"icon-file-pdf";case"zip":case"rar":case"cab":case"7z":return"icon-file-archive";default:return"icon-file-o"}}},post:function(t,i,e){var o,s;t.btnname=e.buttonName||"上传附件";t.userId=u.userId;e.pageState=$(".fm-content").attr("page-state");n.setScopeState(t,e);t.accept="*";t.filters&&(o=t.filters.toLowerCase().replace(/\s/g,"").split("|"),console.log(o),s=[],angular.forEach(o,function(n){s.push("."+n)}),t.accept=s.join(","));t.files=[];t.fileIds=[];t.fileFiles=t.files;t.bpmFiles={linkId:t.linkId,FileId:t.fileIds,files:t.files};!t.taskId||r.getTaskLinkedFiles({taskId:t.taskId,linkId:t.linkId}).then(function(n){t.files=n;_.forEach(t.files,function(n){t.fileIds.push(n.id)});t.bpmFiles.files=t.files});!t.draftId||r.getDraftFile({draftId:t.draftId,linkId:t.linkId}).then(function(n){_.forEach(n,function(n){n.isDraft=!0});t.files=n;_.forEach(t.files,function(n){t.fileIds.push(n.id)});t.bpmFiles.files=t.files});t.event_upload=function(){$(i).find(".picUpload").click()};t.cacelFileItemUpload=function(n){n.remove();n.cancel()};t.event_delete=function(n){n.isDownloading&&t.abortDownloadingFile(n);var i={};i.taskId=t.taskId;i.fileId=n.id;r.deleteFile(i).then(function(){console.log("移除成功");t.deleteFile(n);var i=t.files.indexOf(n);t.files.splice(i,1);t.fileIds.splice(i,1)})};t.uploader.filters.push({name:"customFilter",fn:function(n){var i=n.size,t=i<15728640;return t||mabp.notify.warn("附件应小于15MB"),t}});t.uploader.filters.push({name:"controllerFilter",fn:function(n){var i,r;return t.filters?n.type&&t.filters.split("|").length&&(i=t.filters.split("|"),i.push("jpeg"),i.push("jpg"),i.push("png"),i.push("gif"),i.push("wps"),i.push("txt"),i.push("doc"),i.push("msword"),i.push("docx"),i.push("xls"),i.push("ms-excel"),i.push("excel"),i.push("xlsx"),i.push("msg"),r=i.some(t=>t&&n.type.indexOf(t.toLowerCase())!==-1),!r)?(mabp.notify.warn(" File Not Supported "),!1):!0:!0}});t.uploader.onAfterAddingFile=function(n){n.creationTime=(new Date).getTime();n.userName=u.userName;n.creatorUserId=u.userId;t.uploader.getNotUploadedItems().length&&t.uploader.uploadAll()};t.uploader.onSuccessItem=function(n,i){var e=i.isSuccess,f,r;if(e){for(f=0;f<i.result.length;f++)r=i.result[f],r.creationTime=(new Date).format("yyyy-MM-dd hh:mm"),r.userName=u.userName,r.creatorUserId=u.userId,r.nodeId=t.nodeId,t.files.unshift(r),t.fileIds.unshift(r.id),t.state=="normal"&&t.callbackFunc({selectItem:r});n.remove()}};t.formFiles.push(t.bpmFiles);t.uploader.onProgressItem=function(n,t){console.log("uploader.onProgressItem:",n,t)};t.uploader.onErrorItem=function(n,i){console.dir("uploader.onErrorItem,scope.uploader.queue",t.uploader.queue,n);n.remove();console.error("附件上传失败",n,i);mabp.notify.warn("附件上传失败")};t.$watch("files",function(){var i,n;if(!!t.files){for(i=[],n=0;n<t.files.length;n++)i.push(t.files[n].id);t.fmModel=i.join(",");t.fmModel==""&&(t.fmModel=null)}},!0);t.deleteFile=function(n){console.log("deleteFile",n);f.postMessage.call(parent,"deleteFile",{fileId:n.id,fileName:n.fileName})};t.abortDownloadingFile=function(n){console.log("abortDownloadingFile",n);f.postMessage.call(parent,"abortDownloadingFile",{fileId:n.id,fileName:n.fileName})};t.onMessage=function(n){var r=n.data,i;switch(r.message){case"downloadingFiles":i=r.data||[];i.length>0&&(t.files=_.map(t.files,function(n){return _.map(i,function(t){t.fileId==n.id&&(n=_.extend({},n,{isDownloading:t.isDownloading,isDownloaded:t.isDownloaded,progress:Math.floor(t.progress*100)}))}),n}));console.log(t.files);i.length==0&&(t.files=_.map(t.files,function(n){return _.extend({},n,{isDownloading:!1,isDownloaded:!0,progress:1})}));t.$apply();break;case"downloadingFilesError":return}};window.addEventListener("message",t.onMessage);t.downloadFile=function(n){n.isMobileDownloading=!0;f.postMessage.call(parent,"downloadFile",_.assign({},n))}}}}}}]);
/**** fm-checklist.js *****/
_shared.directive("fmChecklist",["fmTool","mabp.app.module","$timeout",function(n,t,i){return{restrict:"E",replace:!0,template:function(t,i){n.setDefaultMember(i);i.name||(i.name=(i.fmModel||"").toString().substring((i.fmModel||"").lastIndexOf(".")+1));var r=(100/i.columncount).getPrecision(1)-1;return'<div fm-model="'+i.fmModel+'" class="fm-checklist" ng-class="state" ids="{{fmModel}}" ng-blur="event_Blur()"><ul><li ng-repeat="item in items track by $index" ng-class="{true:\'checked\',false:\'\'}[isChecked(item)]" ng-disabled="state == \'disabled\' || state == \'readonly\' || item.'+i.disabledMember+' === true" ng-checked="isChecked(item)"><div class="checkbox-icon"><label class="checkbox-inner"><\/label><input id="{{item.'+i.valueMember+"}}"+("-"+i.fmModel+"-")+'{{$index}}" value="{{item.'+i.valueMember+'}}" name="'+i.name+' " type="checkbox"  ng-click="event_ChangeValue(item, $event)"/><\/div><label for="{{item.'+i.valueMember+"}}"+("-"+i.fmModel+"-")+'{{$index}}" class="checkbox-text">{{item.'+i.displayMember+"}}<\/label><\/li><\/ul><\/div>"},scope:{fmModel:"=",fmCode:"=",items:"=",selectItem:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",filter:"=",callbackFunc:"&"},require:"?^fmCache",compile:function(){return{pre:function(){},post:function(t,r,u,f){t.selectItem=[];t.isLoadBefore=!0;n.setScopeState(t,u);n.setDataSource(t,u,f);t.$watch("filter",function(i,r){!i||i==r||n.setDataSource(t,u)},!0);t.isChecked=function(n){return t.fmModel?(t.fmModel===0&&(t.fmModel="0"),(t.fmModel||"").toString().split(",").indexOf(n[u.valueMember])>=0):!1};n.setDefaultWatch(u,t,r);n.LoadInitData(t,u);t.$watch("fmModel",function(){var r,i,n;if(!t.Init&&(t.selectItem=[],!!t.items)){for(r=t.fmModel?t.fmModel.split(","):[],n=0;n<t.items.length;n++)r.indexOf(t.items[n][u.valueMember])>=0&&t.selectItem.push(t.items[n]);if(u.codeMember&&!!t.selectItem){for(i=[],n=0;n<t.selectItem.length;n++)i.push(t.selectItem[n][u.codeMember]);t.fmCode=i.join(",")}}});t.$watch("items",function(){var i,n;if(!!t.items){for(t.fmModel===0&&(t.fmModel="0"),i=!t.fmModel?[]:(t.fmModel||"").toString().split(","),t.selectItem=[],_tempCode=[],n=0;n<t.items.length;n++)i.indexOf(t.items[n][u.valueMember])>=0&&(t.selectItem.push(t.items[n]),_tempCode.push(t.items[n][u.codeMember]));t.fmCode=_tempCode.join(",")}},!0);t.event_ChangeValue=function(n){t.fmModel===0&&(t.fmModel="0");var r=t.fmModel?(t.fmModel||"").split(","):[],f=r.indexOf(n[u.valueMember]);f>=0?r.splice(f,1):r.push(n[u.valueMember]);t.fmModel=r.join(",");console.info(n[u.displayMember],n[u.valueMember],n[u.codeMember]);t.state==="normal"&&i(function(){t.callbackFunc({selectItem:n,fmModel:t.fmModel,fmCode:t.fmCode})})};t.event_Blur=function(){$(r).removeClass("focus")}}}}}}]);
/**** fm-data-select-button.js *****/
_shared.directive("fmDataSelectButton",["fmTool","$timeout","dialog","mabp.app.module","mabp.app.bpm",function(n,t,i){return{restrict:"E",replace:!0,template:function(t,i){n.setDefaultMember(i);var r=n.setValidate(i);return i.ismulti=i.ismulti!==undefined&&i.ismulti!=="false"?!0:!1,'<div class="ma-data-select fm-data-select-button" ng-click="event_SelectData()" ng-readonly="state==\'readonly\'" ng-class="state" ng-disabled="state==\'disabled\'"><div class="fm-data-select-btn"><button class="button button-clear" type="button"  >'+(i.text?"{{text}}":"{{('Choose' | translate)}}")+'<\/button><i class="arrow-icon"><\/i><\/div><\/div>'},scope:{text:"=",fmModel:"=",fmCode:"=",columns:"=",isOpen:"=",datacode:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",filter:"=",defaultModel:"=",callbackFunc:"&"},compile:function(){return{pre:function(){},post:function(t,r,u){t.ismulti=!u.ismulti||u.ismulti==="false"||t.ismulti!==undefined?!1:!0;n.setScopeState(t,u);n.setDefaultWatch(u,t,r);t.event_SelectData=function(){if(t.state=="normal")switch(t.datatype){case"source":i.open(_shared.dialogs.formSelect,{data:[],datatype:"source",filter:t.filter,selectData:"",column:t.columns,title:u.placeholder,ismulti:t.ismulti,valueMember:u.valueMember,size:u.size}).then(function(n){var f,r,i;if(n!==null){for(f=(n.selectItem||"").split(","),r=[],i=0;i<n.items.length;i++)f.indexOf(n.items[i][u.valueMember])>=0&&r.push(n.items[i]);t.callbackFunc({selectItem:r})}});break;case"view":i.open(_shared.dialogs.formSelect,{datacode:t.datacode,datatype:"view",filter:t.filter,selectData:"",column:t.columns,title:u.formTitle,ismulti:t.ismulti,valueMember:u.valueMember,size:u.size}).then(function(n){var f,r,i;if(n){for(f=(n.selectItem||"").split(","),r=[],i=0;i<n.items.length;i++)f.indexOf(n.items[i][u.valueMember])>=0&&r.push(n.items[i]);t.callbackFunc({selectItem:r})}});break;case"dataitem":i.open(_shared.dialogs.treeSelect,{datacode:t.datacode,datatype:"dataitem",filter:t.filter,selectData:"",column:t.columns,title:u.formTitle,ismulti:t.ismulti,mustleaf:u.mustleaf,size:u.size}).then(function(n){var r,i;if(n!==undefined){if(r=[],!!n.selectItem&&n.selectItem.length>0)for(i=0;i<n.selectItem.length;i++)r.push(n.selectItem[i][u.valueMember]);t.callbackFunc({selectItem:n.selectItem});t.IsSelectData=!0}});break;case"group":i.open(_shared.dialogs.treeSelect,{data:t.items,datatype:"group",selectData:angular.copy(t.selectItem),column:t.columns,title:u.formTitle,ismulti:t.ismulti,mustleaf:u.mustleaf}).then(function(n){var i,r;if(n!==null&&n!==undefined){if(i=[],!!n.selectItem&&n.selectItem.length>0)for(r=0;r<n.selectItem.length;r++)i.push(n.selectItem[r][u.valueMember]);t.fmModel=i.join(",");t.callbackFunc({selectItem:n.selectItem,fmModel:i.join(",")})}});break;case"joblevel":i.open(_shared.dialogs.jobLevelDialog,{value:t.fmModel}).then(function(n){var i,r;if(!!n){if(n.id=n.value,n.text=n.name,i=[],!!t.selectItem&&t.selectItem.length>0)for(r=0;r<t.selectItem.length;r++)i.push(t.selectItem[r][u.valueMember]);t.fmModel=i.join(",");t.callbackFunc({selectItem:[n],fmModel:i.join(",")})}})}}}}}}}]);
/**** fm-data-select.js *****/
_shared.directive("fmDataSelect",["fmTool","$timeout","dialog","mabp.app.module","mabp.app.bpm",function(n,t,i){return{restrict:"E",replace:!0,template:function(t,i){n.setDefaultMember(i);var r=n.setValidate(i);return i.ismulti=i.ismulti!==undefined&&i.ismulti!=="false"?!0:!1,i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1)),'<div fm-model="'+i.fmModel+'" class="ma-data-select '+(i.ismulti?"multi":"single")+" "+i.class+'" ng-class="state" ng-click="event_SelectData()" >'+(!i.placeholder?"":'<div class="placeholder" ng-class="{\'hide\':!!fmModel}">{{placeholder}}<\/div>')+'<div class="select-data-value"><div class="item text-right'+(i.href?"href-item":"")+'" ng-repeat="item in selectItem" ng-mousedown="event_removeSelectItem(item, $event)"><span>{{::item.'+i.displayMember+"}}<\/span>"+(i.ismulti?"":'<i ng-hide="!iClear || state!=\'normal\'" class="icon-times remove" ng-mousedown="clear($event)"><\/i>')+'<\/div><div class="item '+(i.href?"href-item":"")+'" ng-if="(!selectItem || selectItem.length == 0) && !!defaultModel" ng-mousedown="event_clickSelectItem(defaultModel, $event)"><span>{{defaultModel}}<\/span>'+(i.ismulti?"":'<i ng-hide="!iClear || state!=\'normal\'" class="icon-times remove" ng-mousedown="clear($event)"><\/i>')+'<\/div><\/div><div class="fm-data-select-btn"><button class="button button-clear" type="button">{{(\'Choose\' | translate)}}<\/button><i class="arrow-icon"><\/i><\/div><input type="hidden" '+(!i.name?"":'name="'+i.name+'"')+" "+r.join(" ")+' ng-model="fmModel" /><\/div>'},scope:{fmModel:"=",fmCode:"=",items:"=",columns:"=",selectItem:"=",isOpen:"=",style:"@","class":"@",findText:"=",datacode:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",filter:"=",defaultFilter:"=",parentId:"=",defaultModel:"=",callbackFunc:"&",fmBlur:"&"},require:"?^fmCache",link:function(r,u,f,e){f.size=f.size?(""+f.size).toLowerCase():"md";r.placeholder=f.placeholder;r.IsSelectData=!1;r.iClear=r.iClear&&r.iClear!==!1||f.iClear!=undefined&&f.iClear!="false"&&!0;r.ismulti=!f.ismulti||f.ismulti==="false"||r.ismulti!==undefined?!1:!0;isnull=f.isnull==undefined?!0:f.isnull!=undefined&&f.isnull!="false";r.selectItem=[];n.setScopeState(r,f);n.LoadInitData(r,f);var o=u.find(".option");r.isShow=!1;n.setDefaultWatch(f,r,u);r.$watch("items",function(){var i,e,t;if(!!r.items){if(i=0,r.items.length==0?u.addClass("zeroitem"):u.removeClass("zeroitem"),e=r.fmModel?r.fmModel.split(","):[],(f.mustleaf||r.datatype=="group"||r.datatype=="joblevel")&&r.fmModel!=null)r.selectItem=n.getTreeData(r.items,r.fmModel,f),!!r.selectItem&&r.selectItem.length>0&&(r.parentId=r.selectItem[0].parentId);else for(t=0;t<r.items.length;t++)!!r.items[t][f.displayMember]&&r.items[t][f.displayMember].length>i&&(i=r.items[t][f.displayMember].length),e.indexOf(r.items[t][f.valueMember])>=0&&r.selectItem.push(r.items[t]);o.css("width",i+3+"em")}},!0);r.$watch("selectItem",function(t,i){var o,e;if(t==null||i==null||t.length!=0||i.length!=0){if(f.codeMember&&!!r.selectItem){for(o=[],e=0;e<r.selectItem.length;e++)r.selectItem[e]!=null&&r.selectItem[e][f.codeMember]!=null&&o.push(r.selectItem[e][f.codeMember]);r.fmCode=o.join(",")}r.state=="normal"&&n.isInitialed(r,u,f)&&r.callbackFunc({selectItem:r.selectItem,fmModel:r.fmModel})}},!0);r.dataUpdate=function(){var u,o,i,t;if(r.state!="normal"||!r.items||r.fmModel===undefined)r.state!="normal"||r.items||!r.fmModel?r.state=="normal"||!r.fmModel||n.getOne(r,f,null,e):n.setDataSource(r,f,e);else{if(r.datatype!="dataitem"&&r.datatype!="group")if(f.ismulti)for(u=(r.fmModel||"").split(","),o=[],r.selectItem=[],t=0;t<r.items.length;t++)u.indexOf(r.items[t][f.valueMember])>=0&&r.selectItem.push(r.items[t]);else{for(i=!0,t=0;t<r.items.length;t++)if(r.items[t][f.valueMember]==r.fmModel){r.selectItem=[r.items[t]];i=!1;break}i&&(r.selectItem=[])}else r.selectItem=n.getTreeData(r.items,r.fmModel,f),!!r.selectItem&&r.selectItem.length>0&&(r.parentId=r.selectItem[0].parentId);r.IsSelectData&&(r.IsSelectData=!1);r.fmBlur({item:r.$parent.item,selectItem:r.selectItem||[]})}};r.$watch("fmModel",function(t){var e,o,u,i;if(t==undefined&&(r.selectItem=[]),r.Init){if(r.state=="normal"&&!!r.items&&r.fmModel!==undefined){if(r.datatype!="dataitem"&&r.datatype!="group")if(f.ismulti)for(e=(r.fmModel||"").split(","),o=[],r.selectItem=[],i=0;i<r.items.length;i++)e.indexOf(r.items[i][f.valueMember])>=0&&r.selectItem.push(r.items[i]);else{for(u=!0,i=0;i<r.items.length;i++)if(r.items[i][f.valueMember]==r.fmModel){r.selectItem=[r.items[i]];u=!1;break}u&&(r.selectItem=[])}else r.selectItem=n.getTreeData(r.items,r.fmModel,f),!!r.selectItem&&r.selectItem.length>0&&(r.parentId=r.selectItem[0].parentId);r.IsSelectData&&(r.IsSelectData=!1);r.fmBlur({item:r.$parent.item,selectItem:r.selectItem||[]})}}else r.dataUpdate()});r.hasItem=function(n){return n||(n=0),r.items&&(r.items.length>n||Object.keys(r.items).length>n)};r.focus=function(){t(function(){u.find("[type=text]").focus()},100)};r.clear=function(n){r.selectItem=[];r.fmModel="";n.stopPropagation()};r.event_removeSelectItem=function(n,t){f.ismulti&&r.event_selectItem(n,t)};r.event_clickSelectItem=function(n,t){!f.href||window.open(f.href.replace(/{.*?}/g,function(){return r.defaultModel}));f.ismulti&&r.event_clickSelectItem(n,t)};r.event_selectItem=function(n,t){if(r.state=="normal"){if(f.ismulti){var i=r.fmModel?(r.fmModel||"").split(","):[],e=i.indexOf(n[f.valueMember]);e>=0?i.splice(e,1):i.push(n[f.valueMember]);r.fmModel=i.join(",");t.stopPropagation()}else r.fmModel=n[f.valueMember],r.findText="";console.info(n[f.displayMember],n[f.valueMember],n[f.codeMember]);u.focus()}};r.event_SelectData=function(){if(r.state=="normal")switch(r.datatype){case"source":i.open(_shared.dialogs.formSelect,{data:r.items,datatype:"source",filter:r.filter,defaultfilter:r.defaultFilter,selectData:r.fmModel,column:r.columns,title:f.placeholder,ismulti:r.ismulti,valueMember:f.valueMember,size:f.size}).then(function(n){n!==null&&n!==undefined?(r.items=n.items,r.fmModel=n.selectItem,r.IsSelectData=!0,r.defaultFilter=n.defaultFilter):n===null&&(r.fmModel="")});break;case"view":i.open(_shared.dialogs.formSelect,{datacode:r.datacode,datatype:"view",filter:r.filter,defaultfilter:r.defaultFilter,selectData:r.fmModel,column:r.columns,title:f.formTitle,ismulti:r.ismulti,valueMember:f.valueMember,size:f.size}).then(function(n){n!==null&&n!==undefined?(r.items=n.items,r.fmModel=n.selectItem,r.IsSelectData=!0,r.defaultFilter=n.defaultFilter):n===null&&(r.fmModel="")});break;case"dataitem":i.open(_shared.dialogs.treeSelect,{datacode:r.datacode,datatype:"dataitem",filter:r.filter,selectData:angular.copy(r.selectItem),column:r.columns,title:f.formTitle,ismulti:r.ismulti,mustleaf:f.mustleaf,size:f.size}).then(function(n){var i,t;if(n!==undefined){if(r.items=n.items,r.selectItem=n.selectItem,i=[],!!r.selectItem&&r.selectItem.length>0)for(t=0;t<r.selectItem.length;t++)i.push(r.selectItem[t][f.valueMember]);r.fmModel=i.join(",");r.IsSelectData=!0}else n===null&&(r.fmModel="")});break;case"group":i.open(_shared.dialogs.treeSelect,{data:r.items,datatype:"group",filter:r.filter,defaultfilter:r.defaultFilter,selectData:angular.copy(r.selectItem),column:r.columns,title:f.formTitle,ismulti:r.ismulti,mustleaf:f.mustleaf}).then(function(n){var i,t;if(n!==null&&n!==undefined){if(r.items=n.items,r.selectItem=n.selectItem,r.defaultFilter=n.defaultFilter,i=[],!!r.selectItem&&r.selectItem.length>0)for(t=0;t<r.selectItem.length;t++)i.push(r.selectItem[t][f.valueMember]);r.fmModel=i.join(",");r.IsSelectData=!0}else n===null&&(r.fmModel="")});break;case"joblevel":i.open(_shared.dialogs.jobLevelDialog,{value:r.fmModel,ismulti:r.ismulti}).then(function(n){var i,t;if(n!==null&&n!==undefined){if(r.items=n,r.selectItem=n,i=[],!!r.selectItem&&r.selectItem.length>0)for(t=0;t<r.selectItem.length;t++)i.push(r.selectItem[t][f.valueMember]);r.fmModel=i.join(",");r.IsSelectData=!0}else n===null&&(r.fmModel="")})}};r.event_Blur=function(){$(u).removeClass("focus")}}}}]);
/**** fm-datatext-select.js *****/
_shared.directive("fmDatatextSelect",["fmTool","$timeout","dialog","mabp.app.module","mabp.app.bpm",function(n,t,i){return{restrict:"E",replace:!0,template:function(t,i){n.setDefaultMember(i);var r=n.setValidate(i);return i.ismulti=i.ismulti!==undefined&&i.ismulti!=="false"?!0:!1,i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1)),"<div ng-readonly=\"state=='readonly'\" ng-disabled=\"state=='disabled' || "+i.textDisabled+'" fm-model="'+i.fmModel+'" fm-text-model="'+i.fmTextModel+'" class="input-sm ma-datatext-select ma-data-select fm-datatext-select '+(i.ismulti?"multi":"single")+" "+i.class+'" ng-class="state" ng-mousedown="openSelect($event)" ng-blur="event_Blur()">'+(!i.placeholder?"":'<div class="placeholder" ng-class="{\'hide\':!!fmModel}">'+i.placeholder+"<\/div>")+'<div class="select-data-value"><input placeholder="'+i.placeholder+'" class="form-control '+(i.href?"href-item":"")+'" type="" ng-readonly="state==\'readonly\'" ng-disabled="state==\'disabled\' || '+i.textDisabled+'" ng-model="fmTextModel" ng-change="changeTxt()" /><div class="item"><span> {{ fmTextModel }}<\/span><\/div><\/div><button class="select-data-button" type="button" ng-click="event_SelectData()" >'+(i.btntext||"{{('Choose' | translate)}}")+'<\/button><input type="hidden" '+(!i.name?"":'name="'+i.name+'"')+" "+r.join(" ")+' ng-model="fmModel" /><\/div>'},scope:{fmModel:"=",fmTextModel:"=",fmCode:"=",items:"=",columns:"=",selectItem:"=",isOpen:"=",findText:"=",datacode:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",filter:"=",defaultFilter:"=",parentId:"=",defaultModel:"=",callbackFunc:"&",fmBlur:"&"},require:"?^fmCache",compile:function(){return{pre:function(){},post:function(r,u,f,e){var s,o;f.size=f.size?(""+f.size).toLowerCase():"md";r.IsSelectData=!1;r.iClear=r.iClear&&r.iClear!==!1||f.iClear!=undefined&&f.iClear!="false"&&!0;r.ismulti=!1;isnull=f.isnull==undefined?!0:f.isnull!=undefined&&f.isnull!="false";r.selectItem=[];n.setScopeState(r,f);n.LoadInitData(r,f);s=u.find(".option");r.isShow=!1;n.setDefaultWatch(f,r,u);o={id:"",text:""};r.changeTxt=function(){r.fmModel=o.id?r.fmTextModel==o.text?o.id:null:null};r.$watch("items",function(){var i,e,t;if(!!r.items){if(i=0,r.items.length==0?u.addClass("zeroitem"):u.removeClass("zeroitem"),e=r.fmModel?r.fmModel.split(","):[],(f.mustleaf||r.datatype=="group"||r.datatype=="joblevel")&&r.fmModel!=null)r.selectItem=n.getTreeData(r.items,r.fmModel,f),!!r.selectItem&&r.selectItem.length>0&&(r.parentId=r.selectItem[0].parentId);else for(t=0;t<r.items.length;t++)!!r.items[t][f.displayMember]&&r.items[t][f.displayMember].length>i&&(i=r.items[t][f.displayMember].length),e.indexOf(r.items[t][f.valueMember])>=0&&r.selectItem.push(r.items[t]);s.css("width",i+3+"em")}},!0);r.$watch("selectItem",function(t,i){var o,e;if(t==null||i==null||t.length!=0||i.length!=0){if(f.codeMember&&!!r.selectItem){for(o=[],e=0;e<r.selectItem.length;e++)r.selectItem[e]!=null&&r.selectItem[e][f.codeMember]!=null&&o.push(r.selectItem[e][f.codeMember]);r.fmCode=o.join(",")}r.state=="normal"&&n.isInitialed(r,u,f)&&r.callbackFunc({selectItem:r.selectItem,fmModel:r.fmModel})}},!0);r.dataUpdate=function(){var u,o,i,t;if(r.state!="normal"||!r.items||r.fmModel===undefined)r.state!="normal"||r.items||!r.fmModel?r.state!="normal"&&r.fmModel!==undefined&&n.getOne(r,f,null,e):n.setDataSource(r,f,e);else{if(r.datatype!="dataitem"&&r.datatype!="group")if(f.ismulti)for(u=(r.fmModel||"").split(","),o=[],r.selectItem=[],t=0;t<r.items.length;t++)u.indexOf(r.items[t][f.valueMember])>=0&&r.selectItem.push(r.items[t]);else{for(i=!0,t=0;t<r.items.length;t++)if(r.items[t][f.valueMember]==r.fmModel){r.selectItem=[r.items[t]];i=!1;break}i&&(r.selectItem=[])}else r.selectItem=n.getTreeData(r.items,r.fmModel,f),!!r.selectItem&&r.selectItem.length>0&&(r.parentId=r.selectItem[0].parentId);r.IsSelectData&&(r.IsSelectData=!1);r.fmBlur({item:r.$parent.item,selectItem:r.selectItem||[]})}};r.$watch("fmModel",function(t){var e,o,u,i;if(t==undefined&&(r.selectItem=[]),r.Init){if(r.state=="normal"&&!!r.items&&r.fmModel!==undefined){if(r.datatype!="dataitem"&&r.datatype!="group")if(f.ismulti)for(e=(r.fmModel||"").split(","),o=[],r.selectItem=[],i=0;i<r.items.length;i++)e.indexOf(r.items[i][f.valueMember])>=0&&r.selectItem.push(r.items[i]);else{for(u=!0,i=0;i<r.items.length;i++)if(r.items[i][f.valueMember]==r.fmModel){r.selectItem=[r.items[i]];u=!1;break}u&&(r.selectItem=[])}else r.selectItem=n.getTreeData(r.items,r.fmModel,f),!!r.selectItem&&r.selectItem.length>0&&(r.parentId=r.selectItem[0].parentId);r.IsSelectData&&(r.IsSelectData=!1);r.fmBlur({item:r.$parent.item,selectItem:r.selectItem||[]})}}else r.dataUpdate()});r.hasItem=function(n){return n||(n=0),r.items&&(r.items.length>n||Object.keys(r.items).length>n)};r.focus=function(){t(function(){u.find("[type=text]").focus()},100)};r.clear=function(n){r.selectItem=[];r.fmModel="";n.stopPropagation()};r.event_removeSelectItem=function(n,t){!f.href||window.open(f.href.replace(/{.*?}/g,function(t){for(var i in n)if(i.toLowerCase()==t.substr(1,t.length-2).toLowerCase())return n[i];return""}));f.ismulti&&r.event_selectItem(n,t)};r.event_clickSelectItem=function(n,t){!f.href||window.open(f.href.replace(/{.*?}/g,function(){return r.defaultModel}));f.ismulti&&r.event_clickSelectItem(n,t)};r.event_selectItem=function(n,t){if(r.state=="normal"){if(f.ismulti){var i=r.fmModel?(r.fmModel||"").split(","):[],e=i.indexOf(n[f.valueMember]);e>=0?i.splice(e,1):i.push(n[f.valueMember]);r.fmModel=i.join(",");t.stopPropagation()}else r.fmModel=n[f.valueMember],r.findText="";console.info(n[f.displayMember],n[f.valueMember],n[f.codeMember]);u.focus()}};r.event_SelectData=function(){if(r.state=="normal")switch(r.datatype){case"source":i.open(_shared.dialogs.formSelect,{data:r.items,datatype:"source",filter:r.filter,defaultfilter:r.defaultFilter,selectData:r.fmModel,column:r.columns,title:f.placeholder,ismulti:r.ismulti,valueMember:f.valueMember,size:f.size}).then(function(n){n!==null&&n!==undefined?(r.items=n.items,r.fmModel=n.selectItem,r.IsSelectData=!0,r.defaultFilter=n.defaultFilter):n===null&&(r.fmModel="");t(function(){!!r.selectItem&&r.selectItem.length>0&&(r.fmTextModel=r.selectItem[0].text);o=r.selectItem[0]})});break;case"view":i.open(_shared.dialogs.formSelect,{datacode:r.datacode,datatype:"view",filter:r.filter,defaultfilter:r.defaultFilter,selectData:r.fmModel,column:r.columns,title:f.formTitle,ismulti:r.ismulti,valueMember:f.valueMember,size:f.size}).then(function(n){n!==null&&n!==undefined?(r.items=n.items,r.fmModel=n.selectItem,r.IsSelectData=!0,r.defaultFilter=n.defaultFilter):n===null&&(r.fmModel="");t(function(){!!r.selectItem&&r.selectItem.length>0&&(r.fmTextModel=r.selectItem[0].text);o=r.selectItem[0]})});break;case"dataitem":i.open(_shared.dialogs.treeSelect,{datacode:r.datacode,datatype:"dataitem",filter:r.filter,selectData:angular.copy(r.selectItem),column:r.columns,title:f.formTitle,ismulti:r.ismulti,mustleaf:f.mustleaf,size:f.size}).then(function(n){var u,i;if(n!==undefined){if(r.items=n.items,r.selectItem=n.selectItem,u=[],!!r.selectItem&&r.selectItem.length>0)for(i=0;i<r.selectItem.length;i++)u.push(r.selectItem[i][f.valueMember]);r.fmModel=u.join(",");r.IsSelectData=!0}else n===null&&(r.fmModel="");t(function(){!!r.selectItem&&r.selectItem.length>0&&(r.fmTextModel=r.selectItem[0].text);o=r.selectItem[0]})});break;case"group":i.open(_shared.dialogs.treeSelect,{data:r.items,datatype:"group",filter:r.filter,defaultfilter:r.defaultFilter,selectData:angular.copy(r.selectItem),column:r.columns,title:f.formTitle,ismulti:r.ismulti,mustleaf:f.mustleaf}).then(function(n){var u,i;if(n!==null&&n!==undefined){if(r.items=n.items,r.selectItem=n.selectItem,r.defaultFilter=n.defaultFilter,u=[],!!r.selectItem&&r.selectItem.length>0)for(i=0;i<r.selectItem.length;i++)u.push(r.selectItem[i][f.valueMember]);r.fmModel=u.join(",");r.IsSelectData=!0}else n===null&&(r.fmModel="");t(function(){!!r.selectItem&&r.selectItem.length>0&&(r.fmTextModel=r.selectItem[0].text);o=r.selectItem[0]})});break;case"joblevel":i.open(_shared.dialogs.jobLevelDialog,{value:r.fmModel,ismulti:r.ismulti}).then(function(n){var u,i;if(n!==null&&n!==undefined){if(r.items=n,r.selectItem=n,u=[],!!r.selectItem&&r.selectItem.length>0)for(i=0;i<r.selectItem.length;i++)u.push(r.selectItem[i][f.valueMember]);r.fmModel=u.join(",");r.IsSelectData=!0}else n===null&&(r.fmModel="");t(function(){!!r.selectItem&&r.selectItem.length>0&&(r.fmTextModel=r.selectItem[0].text);o=r.selectItem[0]})})}};r.event_Blur=function(){$(u).removeClass("focus")}}}}}}]);
/**** fm-datetime.js *****/
_shared.directive("fmDatetime",["fmTool","$timeout",function(n){return{restrict:"E",replace:!0,template:function(t,i){i.$ctrlType="fm-datetime";n.textInit(i);var r=n.setValidate(i);i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1));switch(i.view){case"hours":i.datetype="time";break;case"month":i.datetype="date";break;case"datetime":i.datetype="datetime-local";break;default:i.datetype="date"}return'<div class="fm-datetime"                        ng-readonly="state==\'readonly\'"                         ng-disabled="state==\'disabled\'"                        ng-class="state"                          field-name="{{fieldName}}"                          >                        <input ng-model="viewModel"                               ng-readonly="state==\'readonly\'"                                ng-disabled="state==\'disabled\'"                               class="form-control"                               type="'+i.datetype+'"'+(!i.name?"":'name="'+i.name+'"')+" "+r.join(" ")+"                         />                    <label ng-if=\"(state=='readonly'||state=='disabled')\" class=\"fm-text-shadetext\">{{ shadeText }}<\/label>                    <\/div > "},scope:{fmModel:"=",unit:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",fmBlur:"&"},link:function(t,i,r){t.shadeText="";t.fmModel||(t.fmModel=moment().format("YYYY/MM/DD HH:mm"),t.shadeText=moment().format("YYYY-MM-DD HH:mm"));t.$watch("viewModel",function(n,i){if(n==i){if(n){var u="";switch(r.view){case"hours":u=moment(n).format("HH:mm");break;case"month":u=moment(n).format("YYYY-MM");break;case"datetime":u=moment(n).format("YYYY-MM-DD HH:mm");break;default:u=moment(n).format("YYYY-MM-DD")}t.shadeText=u}console.log("初始化viewmodel",n,i);return}if(n){console.log("switch",n,r.view);switch(r.view){case"hours":t.fmModel=moment(n).format("HH:mm");break;case"month":t.fmModel=moment(n).format("YYYY/MM");break;case"datetime":t.fmModel=moment(n).format("YYYY/MM/DD HH:mm");break;default:t.fmModel=moment(n).format("YYYY/MM/DD")}}console.log("fm-datetime:",t.fmModel,t.shadeText)});t.viewModel=moment(t.fmModel||new Date).toDate();n.setScopeState(t,r)}}}]);
/**** fm-job-select.js *****/
_shared.directive("fmJobSelect",["fmTool","$timeout","dialog","mabp.app.module","mabp.app.bpm",function(n,t,i){return{restrict:"E",replace:!0,template:function(t,i){n.setDefaultMember(i);var r=n.setValidate(i);return i.ismulti=i.ismulti!==undefined&&i.ismulti!=="false"?!0:!1,i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1)),'<div fm-model="'+i.fmModel+'" class="ma-data-select fm-job-select '+(i.ismulti?"multi":"single")+" "+i.class+'" ng-class="state" ng-mousedown="openSelect($event)" ng-blur="event_Blur()">'+(!i.placeholder?"":'<div class="placeholder"  ng-class="{\'hide\':!!fmModel}">'+i.placeholder+"<\/div>")+'<div class="select-data-value"><div class="item" style="witdh:auto;" ng-repeat="item in selectItem" ng-mousedown="event_removeSelectItem(item, $event)">{{item.text}}'+(i.ismulti?"":'<i ng-hide="!iClear || state!=\'normal\'" class="icon-times remove" ng-mousedown="clear($event)"><\/i>')+'<\/div><div class="item" ng-if="(!selectItem || selectItem.length == 0) && !!defaultModel">{{defaultModel}}<\/div><\/div><div class="fm-data-select-btn" ng-click="event_SelectData()"><button class="button button-clear" type="button"  >{{\'Choose\' | translate}}<\/button><i class="arrow-icon"><\/i><\/div><input type="hidden" '+(!i.name?"":'name="'+i.name+'"')+" "+r.join(" ")+' ng-model="fmModel" /><\/div>'},scope:{fmModel:"=",fmCode:"=",columns:"=",selectItem:"=",isOpen:"=",datacode:"=",fmRequired:"=",fmNormal:"=",fmDisabled:"=",fmReadonly:"=",filter:"=",parentId:"=",defaultModel:"=",callbackFunc:"&",fmBlur:"&"},require:"?^fmCache",compile:function(){return{pre:function(){},post:function(r,u,f,e){r.datatype="job";r.iClear=r.iClear&&r.iClear!==!1||f.iClear!=undefined&&f.iClear!="false"&&!0;r.ismulti=!f.ismulti||f.ismulti==="false"||r.ismulti!==undefined?!1:!0;r.hideuser=r.hideuser&&r.hideuser!==!1||f.hideuser!=undefined&&f.hideuser!="false"&&!0;isnull=f.isnull==undefined?!0:f.isnull!=undefined&&f.isnull!="false";n.setScopeState(r,f,e);r.$watch("filter",function(){!r.filter||r.state!="normal"||n.setDataSource(r,f,e)},!0);var o=u.find(".option");r.selectItem=[];r.isShow=!1;n.setDefaultWatch(f,r,u);r.$watch("selectItem",function(t,i){(t==null||i==null||t.length!=0||i.length!=0)&&(r.fmBlur({item:r.$parent.item||null}),r.state=="normal"&&n.isInitialed(r,u,f)&&r.callbackFunc({selectItem:r.selectItem}))},!0);r.$watch("fmModel",function(){n.getOne(r,f,{hideUser:r.hideuser},e)});r.focus=function(){t(function(){u.find("[type=text]").focus()},100)};r.clear=function(n){r.selectItem=[];r.fmModel="";n.stopPropagation()};r.event_removeSelectItem=function(n,t){f.ismulti&&r.event_selectItem(n,t)};r.event_selectItem=function(n,t){if(r.state=="normal"){if(f.ismulti){var i=r.fmModel?(r.fmModel||"").split(","):[],e=i.indexOf(n[f.valueMember]);e>=0?i.splice(e,1):i.push(n[f.valueMember]);r.fmModel=i.join(",");t.stopPropagation()}else r.fmModel=n[f.valueMember];console.info(n[f.displayMember],n[f.valueMember],n[f.codeMember]);u.focus()}};r.event_SelectData=function(){r.state=="normal"&&i.open(_shared.dialogs.fmJobSelectDialog,{data:r.selectItem,datatype:"source",filter:r.filter,selectData:r.fmModel,column:r.columns,title:f.placeholder,ismulti:r.ismulti,valueMember:f.valueMember,hideUser:r.hideuser}).then(function(n){n!==null&&(r.fmModel=n)})};r.event_Blur=function(){$(u).removeClass("focus")}}}}}}]);
/**** fm-number.js *****/
_shared.directive("fmNumber",["fmTool","$timeout",function(n,t){var i=!1;return{restrict:"E",replace:!0,template:function(t,i){i.$ctrlType="fm-number";n.textInit(i);var r=n.setValidate(i);return i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1)),'<div fm-model="'+i.fmModel+'" title="{{ shadeText }}" class="input-sm fm-text form-control fm-number '+(i.cny!=undefined?"text-align-right":"")+'" ng-class="state" ng-mousedown="event_textboxClick($event)" ng-keydown="event_textBoxKeyDown($event)"><input string-to-number '+(!i.name?"":'name="'+i.name+'"')+" "+r.join(" ")+' placeholder="{{fmPlaceholder}}" class="fm-text-input validate" ng-readonly="state==\'readonly\'" ng-disabled="state==\'disabled\'" type="number" ng-model="fmModel" ng-change="event_changeTxt($event)" ng-focus="event_textFocus($event)" ng-blur="event_textBlur($event)" ng-keypress="event_textBoxKeyPress($event)" autocomplete="off" ma-dynamic-element /><label ng-hide="!hasShadeText()" class="fm-text-shadetext">{{ shadeText }}<\/label><div class="fm-text-tool"><i class="textbox_unit" ng-hide="{{getUnit()==\'\'}}">{{getUnit()}}<\/i><i class="fm-text-tool-clear icon-times" ng-hide="(!iClear) || (state!=\'normal\')" ng-mousedown="clearText($event)"><\/i><\/div><div class="option" title="" style=""><div class="option-item"><ul><li ng-class="{\'active\':item==itemText}" ng-repeat="item in items | filter: findText"  ng-click="selectItem($event, item)" ng-mouseover="event_selectItemMouseOver($event,item)">{{item}}<\/li><\/ul><\/div><\/div><\/div>'},scope:{fmModel:"=",toolHtml:"=",fmUnit:"=",items:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",callbackFunc:"&",fmBlur:"&"},link:function(r,u,f){r.textControl=u.find("input");r.fieldName=f.fieldName;r.fmPlaceholder=f.fmPlaceholder;r.historyValue="";r.iClear=r.iClear||f.iClear!=undefined&&f.iClear!="false"&&!0;n.setScopeState(r,f);r.textControl.on("input",function(){});r.setShadeText=function(){r.fmModel!=null?f.formatStr?r.shadeText=f.formatStr.fill(r.fmModel):!f.formatFunc||(r.shadeText=f.formatFunc(r.fmModel)):r.shadeText=""};r.hasShadeText=function(){return!i||console.log(f,r.state),(!!f.formatStr||!!f.formatFunc)&&r.state!="readonly"&&r.state!="disabled"||r.state=="readonly"||r.state=="disabled"};r.getUnit=function(){return r.fmUnit||f.unit||""};r.findText=function(n){return!r.fmModel||n.indexOf(r.fmModel)>=0?!0:!1};n.setDefaultWatch(f,r,u);r.event_selectItemMouseOver=function(n,t){r.itemText=t};r.$watch("fmModel",function(){if(r.setShadeText(),r.fmModel&&f.scale){var n=(r.fmModel+"").split(".");n.length>1&&(r.fmModel=n[0]+"."+n[1].substring(0,f.scale))}});r.selectItem=function(n,t){r.fmModel=t;r.itemText="";u.removeClass("open");n.stopPropagation()};r.event_textBoxKeyPress=function(n){switch(n.charCode){case 45:(n.target.value.indexOf("-")>0||n.target.selectionStart!=0)&&(n.originalEvent.returnValue=!1);break;case 46:f.scale>0?(n.target.value.indexOf(".")>0||n.target.selectionStart==0)&&(n.originalEvent.returnValue=!1):n.originalEvent.returnValue=!1;break;case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:var i=f.NumLength,t=n.target.value.indexOf(".");t>=0&&n.target.value.indexOf("-")>=0&&i++;t>0&&n.target.value.substring(t).length>6&&n.target.selectionStart>t&&n.target.selectionStart==n.target.selectionEnd?n.originalEvent.returnValue=!1:t==-1?n.target.value.substring(t).length>=i&&n.target.selectionStart==n.target.selectionEnd&&(n.originalEvent.returnValue=!1):n.target.value.substring(0,t).length>=i&&n.target.selectionStart<=t&&n.target.selectionStart==n.target.selectionEnd&&(n.originalEvent.returnValue=!1);break;default:n.originalEvent.returnValue=!1}};r.event_textBoxKeyDown=function(n){if(!!r.items&&r.items.length>0){var i=r.getIndex(r.itemText),t=r.getFindItems();if(u.hasClass("open"))switch(n.keyCode){case 38:i>0?(i--,r.itemText=t[i]):(i=t.length-1,r.itemText=t[t.length-1]);break;case 40:i<t.length-1?(i++,r.itemText=t[i]):(i=0,r.itemText=t[0]);break;case 13:r.fmModel=r.itemText;u.removeClass("open");break;case 8:if(!r.fmModel){u.removeClass("open");r.itemText="";return}default:t.length==0&&u.removeClass("open")}else switch(n.keyCode){case 8:if(!r.fmModel){u.removeClass("open");r.itemText="";return}case 40:case 13:t.length>0&&u.addClass("open");break;default:t.length>0&&(u.removeClass("open"),r.itemText="")}}};r.getIndex=function(n){var i=r.getFindItems(),t;if(!i)return-1;for(t=0;t<i.length;t++)if(n==i[t])return t;return-1};r.getFindItems=function(){var t=[],n;if(!!r.items&&r.items.length>0)for(n=0;n<r.items.length;n++)(!r.fmModel||r.items[n].indexOf(r.fmModel)>=0)&&t.push(r.items[n]);return t};r.event_textboxClick=function(n){n.stopPropagation()};r.event_changeTxt=function(){console.log(r.textControl);r.textControl.val()&&!new RegExp(f.fmPattern).test(r.textControl.val().ReplaceAll(",",""))?r.fmModel=r.historyValue:(r.historyValue=r.fmModel.ReplaceAll(",",""),r.fmModel=r.fmModel.ReplaceAll(",",""));t(function(){r.callbackFunc()},0)};r.itemText="";r.documentClick=function(){angular.element(document).off("mousedown",r.documentClick);t(function(){u.removeClass("open")},0)};r.event_textFocus=function(){u.addClass("focus");angular.element(document).on("mousedown",r.documentClick)};r.event_textBlur=function(){r.fmBlur({item:r.$parent.item||null});u.removeClass("focus")};r.clearText=function(n){r.fmModel="";t(function(){u.children("input").focus()},0);n.stopPropagation()}}}}]).directive("stringToNumber",function(){return{require:"ngModel",link:function(n,t,i,r){r.$parsers.push(function(n){return""+n});r.$formatters.push(function(n){return parseFloat(n,10)})}}});
/**** fm-radiolist.js *****/
_shared.directive("fmRadiolist",["fmTool","mabp.app.module","$timeout",function(n,t,i){return{restrict:"E",replace:!0,template:function(t,i){i.columncount=i.columncount||4;n.setDefaultMember(i);i.name||(i.name=(i.fmModel||"").toString().substring(i.fmModel.lastIndexOf(".")+1));var r=(100/i.columncount).getPrecision(1)-1;return'<div fm-model="'+i.fmModel+'" class="fm-radiogroup" ng-class="state" ids="{{fmModel}}{{random}}" ng-blur="event_Blur()"><ul><li ng-disabled="state == \'disabled\' || state == \'readonly\' || r.'+i.disabledMember+' === true" ng-repeat="r in items track by $index" ng-class="{true:\'checked\',false:\'\'}[isChecked(r)]"><div class="radio-icon" ><label class="radio-inner"><\/label><input  ng-checked="isChecked(r)" id="{{r.'+i.valueMember+"}}"+("-"+i.fmModel+"-")+'{{$index}}" name="'+i.name+'{{random}}" type="radio" value="{{r.'+i.valueMember+'}}" ng-click="event_ChangeValue(r, $event)" /><\/div><label class="radio-text" for="{{r.'+i.valueMember+"}}"+("-"+i.fmModel+"-")+'{{$index}}">{{r.'+i.displayMember+"}}<\/label><\/li><\/div>"},scope:{fmModel:"=",fmCode:"=",items:"=",selectItem:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",filter:"=",callbackFunc:"&",fmBlur:"=",style:"@"},require:"?^fmCache",compile:function(){return{pre:function(){},post:function(t,r,u,f){r.attr("style",t.style);t.random=_$.getGUID().substr(0,4);u.fmModel=="form.pur01.expenseSource"&&console.log(t.fmModel+t.state);t.isLoadBefore=!0;n.setScopeState(t,u);n.setDataSource(t,u,f);t.$watch("filter",function(i,r){!i||i==r||n.setDataSource(t,u,f)},!0);t.isChecked=function(n){return t.fmModel===0&&(t.fmModel="0"),(t.fmModel||"").toString()===n[u.valueMember]};n.setDefaultWatch(u,t,r);n.LoadInitData(t,u);t.$watch("fmModel",function(){var i,r,n;if(!t.Init&&!!t.fmModel&&!!t.items){for(i=!0,n=0;n<t.items.length;n++)if(t.fmModel==t.items[n][u.valueMember]){t.selectItem=[t.items[n]];i=!1;break}if(i&&(t.selectItem=[]),u.codeMember&&!!t.selectItem){for(r=[],n=0;n<t.selectItem.length;n++)r.push(t.selectItem[n][u.codeMember]);t.fmCode=r.join(",")}}});t.$watch("items",function(){var i,n;if(!!t.items){for(t.fmModel===0&&(t.fmModel="0"),i=(t.fmModel||"").toString(),t.selectItem=[],_tempCode=[],n=0;n<t.items.length;n++)if(i==t.items[n][u.valueMember]){t.selectItem.push(t.items[n]);_tempCode.push(t.items[n][u.codeMember]);break}t.fmCode=_tempCode.join(",")}},!0);t.event_ChangeValue=function(n){t.fmModel=n[u.valueMember];console.info(n[u.displayMember],n[u.valueMember],n[u.codeMember]);t.state=="normal"&&i(function(){t.callbackFunc({selectItem:n,fmModel:t.fmModel})})};t.event_Blur=function(){$(r).removeClass("focus")}}}}}}]);
/**** fm-select.js *****/
_shared.directive("fmSelect",["fmTool","$timeout","mabp.app.module","mabp.app.bpm",function(n,t,i){return{restrict:"E",replace:!0,template:function(t,i){n.setDefaultMember(i);var r=n.setValidate(i);return i.ismulti=i.ismulti!==undefined&&i.ismulti!=="false"?!0:!1,i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1)),'<div ng-disabled="state==\'disabled\'" ng-readonly="state==\'readonly\'"class="fm-select '+i.class+'"  ng-class="state" >                                <select class="form-control"                                    ng-disabled="state==\'readonly\'"                                    field-name="'+i.fieldName+'"                                      '+(i.ismulti?"multiple":" ")+'                                     fm-model="'+i.fmModel+'" '+(!i.name?" ":'name="'+i.name+'"')+" "+r.join(" ")+'                                     ma-dynamic-element                                    ng-model="fmModel"                                    >                                    <option value="">--{{(\'Choose\' | translate)}}--<\/option>                                    <option ng-selected="isCheck(item)" ng-repeat="item in items track by item.'+i.valueMember+'" '+('value="{{item.'+i.valueMember)+'}}"                     ng-click="event_selectItem(item, $event)" > {{item.'+i.displayMember+'}}<\/option>                                <\/select>                                <label ng-if="(state==\'disabled\'||state==\'readonly\')" class="fm-text-shadetext">{{selectedItemsDisplayNames.length&&selectedItemsDisplayNames.join(" ")||fmModel}}<\/label>                                <pre class="fm-text-shadetext" ng-if="selectedItemsDisplayNames.length && '+i.ismulti+'">{{selectedItemsDisplayNames.join(",")}}<\/pre>                                <input type="hidden" '+(!i.name?"":'name="'+i.name+'"')+" "+r.join(" ")+' ng-model="fmModel" ma-dynamic-element />                           <\/div > '},scope:{fmModel:"=",fmCode:"=",items:"=",selectItem:"=",isOpen:"=",findText:"=",datacode:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",filter:"=",callbackFunc:"&",fmBlur:"&"},require:"?^fmCache",link:function(r,u,f,e){console.log(r);r.fmPlaceholder=f.fmPlaceholder||"Search";r.isLoadBefore=!0;r.iClear=r.iClear&&r.iClear!==!1||f.iClear!=undefined&&f.iClear!="false"&&!0;isnull=f.isnull==undefined?!0:f.isnull!=undefined&&f.isnull!="false";n.setScopeState(r,f);t(function(){r.state=="normal"},100);r.selectItem=[];r.selectedItemsDisplayNames=[];n.setDefaultWatch(f,r,u);n.LoadInitData(r,f);r.$watch("items",function(n,t){var u,e,i;if(n!==t&&!!r.items){for(u=0,e=(!!r.fmModel||r.fmModel!=="0")&&r.fmModel&&r.fmModel!==0?r.fmModel.toString().split(","):[],r.selectItem=[],_tempCode=[],i=0;i<r.items.length;i++)r.items[i]!=null&&(!!r.items[i][f.displayMember]&&r.items[i][f.displayMember].length>u&&(u=r.items[i][f.displayMember].length),e.indexOf(r.items[i][f.valueMember])>=0&&(r.selectItem.push(r.items[i]),_tempCode.push(r.items[i][f.codeMember])));r.fmCode=_tempCode.join(",")}},!0);r.$watch("datacode",function(t,u){if(!!f.datacode){t==u||!t||!u||(r.selectItem=null,r.ngModel=null,r.selectText="");var o=r.datacode;if(!f.datacodeFormat||(o=f.datacodeFormat.fill(r.datacode)),r.state=="normal")switch(r.datatype){case"view":n.getView(r.datacode,r.filter,function(n){var i,t;if(!!n){for(i={},t=0;t<n.displayColumList.length;t++)n.displayColumList[t].displayColumn=n.displayColumList[t].displayColumn.substring(0,1).toLowerCase()+n.displayColumList[t].displayColumn.substring(1),i[n.displayColumList[t].displayColumn]=n.displayColumList[t].name;r.items=n}},null,e);break;case"dataitem":n.getBasicdata(o,r.filter,function(n){!n||(r.items=n.data)},e)}else n.getOne(r,f,i,e)}});r.$watch("selectItem",function(t,i){var o,e;if(t!==i&&(r.state=="normal"&&n.isInitialed(r,u,f)&&(t&&t.length!=0?r.callbackFunc({selectItem:r.selectItem,fmModel:r.fmModel}):r.callbackFunc({selectItem:[],fmModel:r.fmModel})),o=[],!!r.selectItem)){for(r.selectItem.length>0&&(r.selectedItemsDisplayNames=_.reduce(r.selectItem,function(n,t){var i=_.find(r.items,function(n){return n[f.valueMember]==t[f.valueMember]}),u;return i&&(u=i[f.displayMember],n=_.flatten([n,u])),n},[])),e=0;e<r.selectItem.length;e++)o.push(r.selectItem[e][f.codeMember]);r.fmCode=o.join(",")}},!0);r.dataUpdate=function(){var o,u,i,t;if(r.state!="normal"||!r.items||r.fmModel===undefined)r.items?r.state!="normal"&&r.fmModel!==undefined?n.getOne(r,f,null,e):r.fmModel===undefined&&(r.selectItem={}):n.setDataSource(r,f,e);else{if(f.ismulti)for(o=(r.fmModel||"").split(","),i=[],r.selectItem=[],t=0;t<r.items.length;t++)o.indexOf(r.items[t][f.valueMember])>=0&&r.selectItem.push(r.items[t]);else{for(u=!0,t=0;t<r.items.length;t++)if(r.items[t][f.valueMember]==r.fmModel){r.selectItem=[r.items[t]];u=!1;break}u&&(r.selectItem=[])}if(f.codeMember&&!!r.selectItem){for(i=[],t=0;t<r.selectItem.length;t++)i.push(r.selectItem[t][f.codeMember]);r.fmCode=i.join(",")}}};r.$watch("fmModel",function(n,t){var o,e,u,i;if(n===t){r.Init||r.dataUpdate();return}if(n&&n.length!=0||(r.selectItem=[],r.selectedItemsDisplayNames=[]),t==null||n!=null)if(r.Init){if(r.state=="normal"&&!!r.items&&r.fmModel!==undefined){if(f.ismulti)for(o=(r.fmModel||"").split(","),u=[],r.selectItem=[],i=0;i<r.items.length;i++)o.indexOf(r.items[i][f.valueMember])>=0&&r.selectItem.push(r.items[i]);else{for(e=!0,i=0;i<r.items.length;i++)if(r.items[i][f.valueMember]==r.fmModel){r.selectItem=[r.items[i]];e=!1;break}e&&(r.selectItem=[])}if(f.codeMember&&!!r.selectItem){for(u=[],i=0;i<r.selectItem.length;i++)u.push(r.selectItem[i][f.codeMember]);r.fmCode=u.join(",")}}}else r.dataUpdate()});r.isCheck=function(n){if(!n)return!1;try{return(r.fmModel?r.fmModel.toString().split(","):[]).indexOf(n[f.valueMember])>=0}catch(t){}};r.setOpen=function(n){r.state=="normal"&&(r.isOpen=n,n?u.addClass("open"):u.removeClass("open"))};r.clear=function(n){r.selectItem=[];r.fmModel="";n.stopPropagation()};r.event_ClearItem=function(n){r.fmModel="";r.selectItem=[];n.stopPropagation()};r.event_removeSelectItem=function(n,t){f.ismulti&&r.event_selectItem(n,t)};r.event_selectItem=function(n,t){if(r.state=="normal"){if(f.ismulti){var i=r.fmModel?(r.fmModel||"").split(","):[],e=i.indexOf(n[f.valueMember]);e>=0?i.splice(e,1):i.push(n[f.valueMember]);r.fmModel=i.join(",");r.selectItem=_.map(i,function(n){return _.find(r.items,function(t){return t[f.valueMember]==n})})}else r.fmModel=n[f.valueMember],r.findText="";u.focus()}f.ismulti||r.setOpen(!1);t.stopPropagation()};r.isShowItem=function(n){return r.findText?(n[f.displayMember]||"").toLowerCase().indexOf((r.findText||"").toLowerCase())<0:!1};r.updateState=function(){if(r.state=="normal"&&!r.items)switch(r.datatype){case"view":n.getView(r.datacode,r.filter,function(n){!n||(r.items=n.viewTable)},null,e);break;case"dataitem":n.getBasicdata(r.datacode,r.filter,function(n){!n||(r.items=n.data)},e)}}}}}]);
/**** fm-text.js *****/
_shared.directive("fmText",["fmTool","$timeout",function(n,t){return{restrict:"E",replace:!0,template:function(t,i){i.$ctrlType="fm-text";n.textInit(i);var r=n.setValidate(i);return'<div field-name="{{fieldName}}" class="fm-text" field-text="{{getShadeText()}}" ng-class="state" ng-mousedown="event_textboxClick($event)" ng-keydown="event_textBoxKeyDown($event)"><input '+r.join(" ")+' placeholder="{{fmPlaceholder}}" class="form-control fm-text-input validate"  ng-hide="state==\'readonly\'||state==\'disabled\'" ng-readonly="state==\'readonly\'" ng-disabled="state==\'disabled\'" type="text" ng-model="fmModel" ng-change="event_changeTxt($event)" ng-focus="event_textFocus($event)" ng-blur="event_textBlur($event)"  autocomplete="off" ma-dynamic-element /><label ng-show="('+(!!i.formatStr||!!i.formatFunc)+' && state!=\'readonly\' && state!=\'disabled\') || state==\'readonly\' || state==\'disabled\'" class="fm-text-shadetext">{{getShadeText()}}<\/label><div class="fm-text-tool"><i class="textbox_unit" ng-hide="{{getUnit()==\'\'}}">{{getUnit()}}<\/i><i class="fm-text-tool-clear icon-times" ng-hide="!iClear || state!=\'normal\'" ng-mousedown="clearText($event)"><\/i><\/div><div class="option" title="" style=""><div class="option-item"><ul><li ng-class="{\'active\':item==itemText}" ng-repeat="item in items | filter: findText" style="" ng-mousedown="selectItem($event, item)" ng-mouseover="event_selectItemMouseOver($event,item)">{{::item}}<\/li><\/ul><\/div><\/div>{{execount}}<\/div>'},scope:{fmModel:"=",toolHtml:"=",fmUnit:"=",style:"@",items:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",fmBlur:"&",nodecode:"=",jobcode:"="},link:function(i,r,u){i.textControl=r.find("input");i.textControl.on("input",function(){});i.historyValue="";i.fmPlaceholder=u.fmPlaceholder;i.fieldName=u.fieldName;i.unit=i.unit||u.unit;i.iClear=i.iClear||u.iClear!=undefined&&u.iClear!="false"&&!0;!u.iClear||u.iClear=="false"||(i.iClear=!0);i.keydown=i.keydown||u.keydown!=undefined&&u.keydown!="false"&&!0;n.setScopeState(i,u);i.getShadeText=function(){return i.fmModel!=null?u.formatStr?u.formatStr.fill(i.fmModel):u.formatFunc?u.formatFunc(i.fmModel):i.fmModel:""};i.hasShadeText=function(){return(!!u.formatStr||!!u.formatFunc)&&i.state!="readonly"&&i.state!="disabled"||i.state=="readonly"||i.state=="disabled"};i.getUnit=function(){return i.fmUnit||u.unit||""};i.findText=function(n){return!i.fmModel||n.indexOf(i.fmModel)>=0?!0:!1};n.setDefaultWatch(u,i,r);i.event_selectItemMouseOver=function(n,t){i.itemText=t};i.selectItem=function(n,t){i.fmModel=t;i.itemText="";r.removeClass("open");n.stopPropagation()};i.event_textBoxKeyDown=function(n){var e,o,f,t;if(!i.keydown||n.keyCode==13&&i.event_textBlur(),u.creditcard!=undefined&&u.creditcard!=="false"){e=!1;switch(n.key){case"0":case"1":case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":case"Backspace":case"ArrowLeft":case"ArrowRight":case"Delete":break;default:e=!0}if(e)switch(n.keyCode){case 8:case 37:case 39:case 46:case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:break;default:n.originalEvent.returnValue=!1}}if(u.qty!=undefined&&u.qty!=="false"){o=!1;switch(n.key){case"0":case"1":case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":case".":case"Backspace":case"ArrowLeft":case"ArrowRight":case"Delete":break;default:o=!0}if(o)switch(n.keyCode){case 8:case 37:case 39:case 46:case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:case 190:break;default:n.originalEvent.returnValue=!1}}if(!!i.items&&i.items.length>0)if(f=i.getIndex(i.itemText),t=i.getFindItems(),r.hasClass("open"))switch(n.keyCode){case 38:f>0?(f--,i.itemText=t[f]):(f=t.length-1,i.itemText=t[t.length-1]);break;case 40:f<t.length-1?(f++,i.itemText=t[f]):(f=0,i.itemText=t[0]);break;case 13:i.fmModel=i.itemText;r.removeClass("open");break;case 8:if(!i.fmModel){r.removeClass("open");i.itemText="";return}default:t.length==0&&r.removeClass("open")}else switch(n.keyCode){case 8:if(!i.fmModel){r.removeClass("open");i.itemText="";return}case 40:case 13:t.length>0&&r.addClass("open");break;default:t.length>0&&(r.removeClass("open"),i.itemText="")}};i.getIndex=function(n){var r=i.getFindItems(),t;if(!r)return-1;for(t=0;t<r.length;t++)if(n==r[t])return t;return-1};i.getFindItems=function(){var t=[],n;if(!!i.items&&i.items.length>0)for(n=0;n<i.items.length;n++)(!i.fmModel||i.items[n].indexOf(i.fmModel)>=0)&&t.push(i.items[n]);return t};i.event_textboxClick=function(n){n.stopPropagation()};i.event_changeTxt=function(){u.qty!=undefined&&u.qty!=="false"&&(new RegExp("^(-?[0-9]{1,12}(\\.([0-9]{1,11})?)?)?$").test(i.textControl.val().replace(",",""))?(i.historyValue=i.fmModel.replace(",",""),i.fmModel=i.fmModel.replace(",","")):i.fmModel=i.historyValue);u.creditcard!=undefined&&u.creditcard!=="false"&&(new RegExp("^(-?[0-9]{1,})?$").test(i.textControl.val().replace(",",""))?(i.historyValue=i.fmModel.replace(",",""),i.fmModel=i.fmModel.replace(",","")):i.fmModel=i.historyValue)};i.itemText="";i.documentClick=function(){angular.element(document).off("mousedown",i.documentClick);t(function(){r.removeClass("open")},0)};i.event_textFocus=function(){r.addClass("focus");angular.element(document).on("mousedown",i.documentClick)};i.event_textBlur=function(){i.fmBlur({item:i.$parent.item||null});r.removeClass("focus")};i.clearText=function(){i.fmModel=""};i.$watch("fmModel",function(){u.creditcard!=undefined&&u.creditcard!=="false"&&(i.fmModel=i.trim(i.fmModel,"g"))});i.trim=function(n,t){if(!n)return n;var i;return i=n.replace(/(^\s+)|(\s+$)/g,""),t.toLowerCase()=="g"&&(i=i.replace(/\s/g,"")),i}}}}]);
/**** fm-textarea.js *****/
_shared.directive("fmTextarea",["fmTool","$timeout",function(n,t){return{restrict:"E",replace:!0,template:function(t,i){i.$ctrlType="fm-textarea";n.textInit(i);var r=n.setValidate(i);return i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1)),'<div ng-class="state"  field-text="{{fmModel}}" class="validate fm-textarea" ng-mousedown="event_textboxClick($event)" ng-keydown="event_textBoxKeyDown($event)"><textarea row="3"'+(!i.name?"":' name="'+i.name+'"')+" "+r.join(" ")+' placeholder="{{fmPlaceholder}}" class="form-control"  ng-readonly="state==\'readonly\'" ng-disabled="state==\'disabled\'" type="text" ng-model="fmModel" ng-change="event_changeTxt()" ng-focus="event_textFocus($event)" ng-blur="event_textBlur($event)" ma-dynamic-element ><\/textarea><div class="fm-text-tool"><i class="fm-text-tool-clear icon-times" ng-hide="!iClear || state!=\'normal\'" ng-mousedown="clearText($event)"><\/i><\/div><div class="option" title="" style=""><div class="option-item"><ul><li ng-class="{\'active\':item==itemText}" ng-repeat="item in items | filter: findText" style="" ng-click="selectItem($event, item)" ng-mouseover="event_selectItemMouseOver($event,item)">{{item}}<\/li><\/ul><\/div><\/div><\/div>'},scope:{fmModel:"=",toolHtml:"=",items:"=",fmNormal:"=",fmDisabled:"=",fmReadonly:"=",fmRequired:"=",fmHeight:"="},link:function(i,r,u){i.fmPlaceholder=u.fmPlaceholder;i.iClear=i.iClear||u.iClear!=undefined&&u.iClear!="false"&&!0;!u.iClear||u.iClear=="false"||(i.iClear=!0);$("textarea:not([disabled][readonly])").each(function(){this.addEventListener("input",function(n){var r=$(n.target),t=r.parents(".fm-textarea"),i;t.height()<n.target.scrollHeight&&(i=0,i+=n.target.scrollHeight-t.height(),t.css({height:"auto",height:n.target.scrollHeight}),window.scrollBy(0,i))},{passive:!0,capture:!1})});n.setScopeState(i,u);i.findText=function(n){return!i.fmModel||n.indexOf(i.fmModel)>=0?!0:!1};n.setDefaultWatch(u,i,r);i.event_selectItemMouseOver=function(n,t){i.itemText=t};i.selectItem=function(n,t){i.fmModel=t;i.itemText="";r.removeClass("open");n.stopPropagation()};i.event_textBoxKeyDown=function(n){if(!!i.items&&i.items.length>0){var u=i.getIndex(i.itemText),t=i.getFindItems();if(r.hasClass("open"))switch(n.keyCode){case 38:u>0?(u--,i.itemText=t[u]):(u=t.length-1,i.itemText=t[t.length-1]);break;case 40:u<t.length-1?(u++,i.itemText=t[u]):(u=0,i.itemText=t[0]);break;case 13:i.fmModel=i.itemText;r.removeClass("open");break;case 8:if(!i.fmModel){r.removeClass("open");i.itemText="";return}default:t.length==0&&r.removeClass("open")}else switch(n.keyCode){case 8:if(!i.fmModel){r.removeClass("open");i.itemText="";return}case 40:case 13:t.length>0&&r.addClass("open");break;default:t.length>0&&(r.removeClass("open"),i.itemText="")}}};i.getIndex=function(n){var r=i.getFindItems(),t;if(!r)return-1;for(t=0;t<r.length;t++)if(n==r[t])return t;return-1};i.getFindItems=function(){var t=[],n;if(!!i.items&&i.items.length>0)for(n=0;n<i.items.length;n++)(!i.fmModel||i.items[n].indexOf(i.fmModel)>=0)&&t.push(i.items[n]);return t};i.event_textboxClick=function(n){n.stopPropagation()};i.event_changeTxt=function(){};i.itemText="";i.documentClick=function(){angular.element(document).off("mousedown",i.documentClick);t(function(){r.removeClass("open")},0)};i.event_textFocus=function(){r.addClass("focus");angular.element(document).on("mousedown",i.documentClick)};i.event_textBlur=function(){r.removeClass("focus")};i.clearText=function(n){i.fmModel="";$(n.target).parents(".fm-textarea").css({height:"auto"}).find("textarea").height(0);t(function(){r.children("textarea").focus()},0);n.stopPropagation()}}}}]);
/**** fm-applicant.js *****/
_shared.directive("fmApplicant",["$compile","dialog","mabp.app.taskRead",function(n,t,i){return{restrict:"E",replace:!0,template:function(){return'<div class="row"><div class="form-group"><div class="col-xs-12"><span class="col-xs-2 control-label">{{ "ApplicantName" | translate }}<\/span><div class="col-xs-4"><div class="input-group" style="width: 100%;"><span class="form-label">{{userinfo.userName}}<\/span><span class="input-group-btn" ng-if="!taskid"><button class="btn btn-default" type="button" ng-click="selectUser()">{{ "Choose" | translate }}<\/button><\/span><\/div><\/div><span class="col-xs-2 control-label">{{ "ApplicantEmployeeNumber" | translate }}<\/span><div class="col-xs-4"><span class="form-label">{{userinfo.employeeNumber}}<\/span><\/div><\/div><\/div><div class="form-group"><div class="col-xs-12"><span class="col-xs-2 control-label">{{ "ApplicantDepartment" | translate }}<\/span><div class="col-xs-10"><span class="form-label">{{userinfo.departmentName}}<\/span><\/div><\/div><\/div><div class="form-group" ng-if="!contactHide"><div class="col-xs-12"><span class="col-xs-2 control-label">{{ "ApplicantTelephone" | translate }}<\/span><div class="col-xs-4"><span class="form-label">{{userinfo.contactNumber}}<\/span><\/div><span class="col-xs-2 control-label">{{ "ApplicantEmail" | translate }}<\/span><div class="col-xs-4"><span class="form-label">{{userinfo.emailAddress}}<\/span><\/div><\/div><\/div><\/div>'},scope:{jobid:"=",userinfo:"=",taskid:"=",wfid:"=",areaCode:"="},link:function(n,r,u){u.contactHide==="true"&&(n.contactHide=!0);n.userinfo||(n.taskid?i.getFormHeaderInfo({taskId:n.taskid}).then(function(t){!t||(n.userinfo={jobId:t.applicantJobId,groupId:t.applicantGroupId,userId:t.applicantUserId,directManagerJobId:t.applicantDirectManagerJobId,department:t.applicantDepartment,userName:t.applicantUserName,employeeNumber:t.applicantEmployeeNumber,departmentName:t.applicantDepartmentName,contactNumber:t.applicantContactNumber,mobileNumber:t.applicantMobileNumber,emailAddress:t.applicantEmailAddress,directManagerName:t.applicantDirectManagerName,areaCode:t.areaCode})}):i.getUserInfo({jobId:n.jobid}).then(function(t){n.userinfo={jobId:t.jobId,groupId:t.groupId,userId:t.userId,directManagerJobId:t.directManagerJobId,department:t.department,userName:t.userName,employeeNumber:t.employeeNumber,departmentName:t.departmentName,contactNumber:t.telephone,mobileNumber:t.cellPhone,emailAddress:t.emailAddress,directManagerName:t.directManagerName,areaCode:t.areaCode}}));n.selectUser=function(){t.open(_shared.dialogs.formSelect,{datatype:"service",jobId:n.jobid,wfdWorkflowId:n.wfid,areaCode:n.areaCode}).then(function(t){var u=n.jobid,f=null,r;!t||(r=_.find(t.items,{id:t.selectItem}),!r||(u=r.applicantJobId,f=r.applicantUserId));i.getUserInfo({jobId:u,userId:f}).then(function(t){n.userinfo={jobId:t.jobId,groupId:t.groupId,userId:t.userId,directManagerJobId:t.directManagerJobId,department:t.department,userName:t.userName,employeeNumber:t.employeeNumber,departmentName:t.departmentName,contactNumber:t.telephone,mobileNumber:t.cellPhone,emailAddress:t.emailAddress,directManagerName:t.directManagerName,areaCode:t.areaCode}})})}}}}]);
/**** fm-approve-history.js *****/
"use strict";_shared.directive("fmApproveHistory",["mabp.app.task","workflowModuleTransfer","$timeout","dialog","appSession",function(n,t,i,r,u){return{restrict:"AE",replace:!0,scope:{taskId:"=",taskInfos:"=",isall:"=",approveHistory:"=",expectApprover:"="},template:function(){return'                <div class="container">                    <div class="form-group">                        <div class="row pull-right">                            <div class="col-xs-12" style="text-align: right; padding-right: 20px;margin-right: 10px;">                                <div class="col-xs-6">                                    <button  class="button" style="margin-right: 5px;font-size:1.3rem" ng-click="showSkip()">                   <span ng-if="!isSkip" >{{ "ShowAllStep" | translate}}<\/span>                                      <span ng-if="isSkip" >{{ "Hide" | translate}}<\/span>                                    <\/button>                                <\/div>                                <div class="col-xs-6">                                     <button class="button small" style="font-size:1.3rem" ng-click="mailToAll()">                                        <span class="ng-scope">Mail To All<\/span>                                     <\/button>                                <\/div>                            <\/div>                        <\/div>                    <\/div>                    <timeline>                        <timeline-event ng-repeat="evt in taskInfos"  side="right" ng-class="{true:\'process-timeline\',false:\'\'}[!!evt.recvTime]">                            <timeline-badge ng-style="{{evt.badgeBgStyle}}"><\/timeline-badge>                            <timeline-panel>                                <timeline-heading>                                    <strong ng-if="getProcer(evt)">{{getProcer(evt)}}：{{evt.action}}<\/strong>                                        <br ng-if="getProcer(evt)"/>                                    <div>{{ "NodeName" | translate}}：{{evt.wfdWorkflowNodeName}}<\/div>                                <\/timeline-heading>                                <div ng-if="evt.recvTime">                                    {{"ReceiveDate"|translate}}：{{evt.recvTime| date : "yyyy-MM-dd HH:mm:ss"}}                                <\/div>                                <div ng-if="!evt.recvTime">{{"ReceiveDate"|translate}}：{{ "UnReceived" | translate}}<\/div>                                <div>{{ "CompletionTime" | translate}}：{{evt.procTime | date : "yyyy-MM-dd HH:mm:ss"}}<\/div>                                <p style="margin-bottom:0">{{ "Memo" | translate}}：{{evt.note}}<\/p>                                <timeline-footer>                                    <strong>{{ "Operation" | translate}}：<\/strong>                                        <i style="font-size:2rem;margin-right:2rem;" ng-if="(evt.type == 1 || evt.type == 0) && (evt.procStatus == 1 || evt.procStatus == 2)" class="icon icon-history cursor-pointer" ng-click="backTask(evt)"><\/i>                                        <i  style="font-size:2rem;" ng-if="evt.procStatus != null && evt.type != 6" class="icon icon-envelope cursor-pointer" ng-click="sendEmail(evt)"><\/i>                                <\/timeline-footer>                            <\/timeline-panel>                        <\/timeline-event>                    <\/timeline>                   <\/div> '},link:function(f){f.$watch("isall",function(n){n!=undefined&&(f.isSkip=!n,i(function(){f.showSkip()},1e3))});f.isSkip=!1;f.$watch("approveHistory",function(){if(!!f.approveHistory&&!!f.approveHistory[0]){var n=f.approveHistory;f.allTaskInfos=n;f.hideSkipTaskInfos=_.filter(n,function(n){return n.procStatus!=="11"});f.taskInfos=f.hideSkipTaskInfos;f.expectTaskInfos=f.expectApprover}});f.showSkip=function(){f.isSkip=!f.isSkip;f.taskInfos=f.isSkip?f.allTaskInfos.concat(f.expectTaskInfos):f.hideSkipTaskInfos};f.pageOpen=function(n){t.hsitory(n.moduleId,n.appPageId,n.wfdWorkflowNodeId,n)};f.backTask=function(t){mabp.ui.setBusying(".fm-form-block",n.backToNode({taskId:f.taskId,nodeId:t.wfdWorkflowNodeId}).then(function(n){n?mabp.notify.success("回滚成功!"):mabp.notify.warn("未在测试环境，该功能不可使用!")}))};f.changeLogin=function(n){window.location.href="/Account/ChangeLoginInfo?newUserId="+n.procUserId};f.getProcer=function(n){return n.procUserName===n.procOwnerName?n.procUserName:n.procUserName+"("+L("ProxyFor")+n.procOwnerName+")"};f.getAction=function(n){switch(n){case"同意":return!0;case"提交":return!1;default:return!1}};f.sendEmail=function(n){n.mailToAll=!1;r.open(_shared.dialogs.emailDialog,{sendTo:n,currentUserInfo:u},function(){})};f.mailToAll=function(){var n={sendTos:[],mailToAll:!0};_.filter(f.taskInfos,function(t){n.sendTos.indexOf(t.procUserEmailAddress)<0&&n.sendTos.push(t.procUserEmailAddress);n.workflowName=t.workflowName;n.sn=t.sn;n.taskId=t.taskId});r.open(_shared.dialogs.emailDialog,{sendTo:n,currentUserInfo:u},function(){})}}}}]);
/**** fm-form-title.js *****/
_shared.directive("fmFormTitle",["fmTool","$filter","mabp.app.bpm","mabp.app.permission","appSession","$timeout","formHelper",function(n,t,i,r,u,f,e){return{restrict:"E",replace:!0,template:function(n,t){return'<div class="row" style="background:white;">                              <div class="container">                                <div class="form-group" ng-if="shoulMobileDisplayTitle">                                    <div class="col-xs-12 text-center">                                        <h2 class="form-small-title row" style="padding-left: 2rem;"><br ng-if="!!titleCompanyName" />{{subTitle}}<\/h2>                                    <\/div>                                <\/div>                                <div style= "height:1rem ;" ng-if="!shoulMobileDisplayTitle"><\/div >                                 <div style= "height:4rem ;" ng-if="shoulMobileDisplayTitle"><\/div >                                 <div class="form-group" ng-if="selectCompany&&items.length>1">                                    <div class="col-xs-3">                                        <span class="control-label required" > {{ "UsedInCompany" | translate }}<\/span>                                    <\/div>                                    <div class="col-xs-9">                                        <select                                                fm-model="'+t.fmModel+'"                                                 field-name="{{ \'UsedInCompany\' | translate }}"                                                ng-model="fmModel"                                                required                                                ng-change="event_selectItem()"                                                ng-options="item.areaCode as item.text for item in items"                                                style = "padding:0.2rem;line-height:auto; height:auto;margin: 0 0px 0 5px;"                                                class="form-control"                                                ng-class="state" >                                        <\/select>                                    <\/div>                                <\/div>                                    <div class="form-group pull-right">                                        <div class="col-xs-12">                                            <span fm-bind="$parent.base.$pageLang.ApplicationTime"><\/span>：                                            <span fm-bind="applyDate" ng-if="!date"><\/span>&nbsp;&nbsp;&nbsp;&nbsp;                                            <span fm-bind="$parent.base.$pageLang.Sn"><\/span>：                                            <span fm-bind="applySnNumber" ng-if="!attr.snNumber"><\/span>                                        <\/div>                                    <\/div>                                <\/div>                        <\/div>'},scope:{fmModel:"=",subTitle:"=",title:"=",selectCompany:"=",callbackFunc:"&"},link:function(r,u,o){var s,c,h;r.hasShownTitle=!1;s=r.$parent.base;r.shoulMobileDisplayTitle=s.basicAndViewData.showHeaderAndTitle;r.selectCompany=s.areaEnable;r.applySnNumber=o.snNumber||s.$pageLang.AutomaticGenerationSystem;c=t("date")(o.applyDate,"yyyy-MM-dd");r.applyDate=c||s.$pageLang.AutomaticGenerationSystem;n.setScopeState(r,o);h=s.applicant.areaCode;!s.taskId&&!s.draftId||(h=s.areaCode);r.selectCompany&&!s.taskId?f(function(){if(r.items=s.areaCodeList,r.companies=_.map(r.items,function(n){return _.assign({},n,{id:n.companyId})}),r.items.length!=1&&r.state!="readonly"&&r.state!="disabled"&&(u.find("select").css("display","inline"),u.find("#div_comspan").css("display","inline")),r.$watch("fmModel",function(n){var i,t;if(r.titleCompanyName="",i=[],n)for(t=0;t<r.items.length;t++)r.items[t].areaCode==n&&(r.titleCompanyName=r.items[t].text,i=r.items[t]);r.appendTitle();r.state=="normal"&&r.callbackFunc(i)}),r.items.length==1)s.areaCode=r.items[0].areaCode;else if(r.items.length>1){var n=_.filter(r.items,function(n){return n.areaCode===h});n!=null&&n.length===1&&(s.areaCode=h)}}):(s.taskId||(s.areaCode=h),!s.areaCode||i.getGroupExtensionByAreaCode({id:s.areaCode,displayLanguages:s.displayLanguages}).then(function(n){n&&(r.titleCompanyName=_.find(n,{displayLanguages:s.displayLanguages}).name,r.appendTitle())}));r.appendTitle=function(){if(console.log("shoulMobileDisplayTitle",{title:r.titleCompanyName,subTitle:r.subTitle},r.$parent.base),r.titleCompanyName){e.postMessage.call(parent,"showHeaderAndTitle",{title:r.titleCompanyName,subTitle:r.subTitle});u.find("h2").html(r.titleCompanyName+"<i class='return-bt  button-clear'><\/i><br ng-if='!!titleCompanyName' /><label class='sub-title'>"+r.subTitle+"<\/label>");var n=u.find("i.return-bt")[0];$(n).click(function(){e.postMessage.call(parent,"goBackMethod")})}else u.find("h2").html(r.subTitle),e.postMessage.call(parent,"showHeaderAndTitle",{title:r.subTitle,subTitle:null})};r.event_selectItem=function(){r.fmModel=u.find("option:selected").val().split(":")[1];u.focus()}}}}]);
/**** fm-group-head.js *****/
_shared.directive("fmGroupHead",["$compile","$timeout",function(n,t){return{restrict:"E",replace:!0,template:function(n,t){return'<div class="row fm-group-head"><div class="col-xs-12"><span class="fm-group-head-ltitle">{{lTitle}}<\/span>&nbsp;&nbsp;'+(!t.subTitle?"":'<span class="fm-group-head-stitle">{{sTitle}}<\/span>')+'<i class="down-ico"><\/i><\/div><\/div>'},scope:{lTitle:"=",sTitle:"=",fmTitle:"="},link:function(n,i,r){i.find("span").html(r.title);n.$watch("fmTitle",function(n){i.find("span").html(n)});n.lTitle=r.title;n.sTitle=r.subTitle;n.$watch("lTitle",function(t){!t||(n.lTitle=t)});n.$watch("sTitle",function(t){!t||(n.sTitle=t)});var u=$(i).parents("dl");$(i).click(function(){u.hasClass("open")?(u.removeClass("open"),u.children("dd").slideUp()):(u.addClass("open"),u.children("dd").slideDown())});t(function(){u.hasClass("open")&&u.children("dd").slideDown()},100)}}}]);
/**** fm-initiator.js *****/
