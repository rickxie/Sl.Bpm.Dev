...
/**** fm-datetime.js *****/
_shared.directive("fmDatetime",["fmTool","$timeout",function(n){return{restrict:"E",replace:!0,template:function(t,i){i.$ctrlType="fm-datetime";n.textInit(i);var r=n.setValidate(i);i.name||(i.name=i.fmModel.toString().substring(i.fmModel.lastIndexOf(".")+1));switch(i.view){case"hours":i.datetype="time";break;case"month":i.datetype="date";break;case"datetime":i.datetype="datetime-local";break;default:i.datetype="date"}return'<div class="fm-datetime"                        ng-readonly="state==\'readonly\'"                         ng-disabled="state==\'disabled\'"                        ng-class="state"                          field-name="{{fieldName}}"                          >                        <input ng-model="viewModel"                               ng-readonly="state==\'readonly\'"                                ng-disabled="state==\'disabled\'"                               class="form-control"                               type="'+i.datetype+'"'+(!i.name?"":'name="'+i.name+'"')+" "+r.join(" ")+"                         />                    <label ng-if=\"(state=='readonly'||state=='disabled')\" class=\"fm-text-shadetext\">{{ shadeText }}<\/label>                    <\/div > "},scope:{fmModel:"=",unit:"=",fmNormal:"=",fmRequired:"=",fmDisabled:"=",fmReadonly:"=",startDate:"=",endDate:"=",fmBlur:"&",fmChange:"&"},link:function(t,i,r){t.shadeText="";t.fmModel||(t.fmModel=moment().format("YYYY/MM/DD HH:mm"),t.shadeText=moment().format("YYYY-MM-DD HH:mm"));t.$watch("viewModel",function(n,i){if(n==i){if(n){var u="";switch(r.view){case"hours":u=moment(n).format("HH:mm");break;case"month":u=moment(n).format("YYYY-MM");break;case"datetime":u=moment(n).format("YYYY-MM-DD HH:mm");break;default:u=moment(n).format("YYYY-MM-DD")}t.shadeText=u}console.log("初始化viewmodel",n,i);return}if(n){console.log("switch",n,r.view);switch(r.view){case"hours":t.fmModel=moment(n).format("HH:mm");break;case"month":t.fmModel=moment(n).format("YYYY/MM");break;case"datetime":t.fmModel=moment(n).format("YYYY/MM/DD HH:mm");break;default:t.fmModel=moment(n).format("YYYY/MM/DD")}}console.log("fm-datetime:",t.fmModel,t.shadeText)});t.viewModel=moment(t.fmModel||new Date).toDate();n.setScopeState(t,r)}}}]);
/**** fm-job-select.js *****/
