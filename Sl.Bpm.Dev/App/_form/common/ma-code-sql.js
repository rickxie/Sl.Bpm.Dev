        ...
        '$compile', '$timeout', 'mabp.app.module', 'appSession', function ($compile, $timeout, service, appSession) {
            return {
                ...
                link: function (scope, element, attr, ctrl) {
                    ...
                    var tablesname = ["AppAuditLog", "AppBusinessTable", "AppBusinessTableColumn", "AppBusinessTableColumnChangeHistory", "AppEnterprise", "AppEnterpriseLanguage", "AppEnterpriseSetting", "AppEnterpriseUser", "AppLanguage", "AppPage", "AppUser", "BpmBasicData", "BpmEnum", "BpmGroup", "BpmInterfaceConfig", "BpmInterfaceMappingConfig", "BpmInterfaceServerConfig", "BpmJob", "BpmJobUser", "BpmLanguage", "BpmModule", "BpmModuleFavourite", "BpmModulePageRight", "BpmModuleRight", "BpmReport", "BpmRole", "BpmRoleJob", "BpmViewTable", "BpmViewTableColumn", "InstAgent", "InstAttachment", "InstDraft", "InstFile", "InstMail", "InstProc", "InstProcLink", "InstSerial", "InstShare", "InstTask", "InstTaskCopy", "InstTaskTop", "InstTaskMark", "InstVariable", "pur_inst_processor", "WfdCategory", "WfdWorkflow", "WfdWorkflowLink", "WfdWorkflowLinkPoint", "WfdWorkflowNode", "WfdWorkflowNodeAction", "WfdWorkflowNodeCopyConfig", "WfdWorkflowNodeInformConfig", "WfdWorkflowNodePreProcessorConfig", "WfdWorkflowObject", "WfdWorkflowProcessor", "WfdWorkflowVariable"];
