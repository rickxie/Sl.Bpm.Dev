...
/**** job.dialog.js *****/
(function(){var n=_shared.dialogs.define("jobDialog","/App/_shared_mobile/component/job/job.dialog.html");angular.module("app.shared").controller(n,["mabp.app.bpm","params","$scope","treeTool",function(n,t,i,r){var u=this;u.selectedGroupId="";u.jobs=[];u.selectTxt="";u.myKeyup=function(){window.event.keyCode==13&&u.loadJobList()};u.save=function(n){i.$close(n)};n.getGroupTree().then(function(n){u.groupArray=n;var t=r.toFormatTreeJson(_.filter(n,{isRoot:!0}),u.selectedGroupId)[0];u.allGroups=r.toFormatTreeJson(_.filter(n,{isRoot:!1}),u.selectedGroupId);u.allGroups.push(t)});i.$watch("vm.selectedGroupId",function(i){u.selectTxt="";!i||n.getJobs({GroupId:u.selectedGroupId,EnterpriseId:t.enterpriseId}).then(function(n){u.jobList=n})});u.loadJobList=function(){n.getAllJobs({GroupId:u.selectedGroupId,EnterpriseId:t.enterpriseId,Filter:{name:"filter",value:u.selectTxt}}).then(function(n){u.jobList=n})}}])})();
...
/**** page.dialog.js *****/
(function(){var n=_shared.dialogs.define("$pageDialog","/App/_shared_mobile/module/page.dialog.html");_shared.controller(n,["$scope","params","viewDialog","mabp.app.workflow","mabp.app.data","formHelper","$compile","$timeout","$pageDialog",function(n,t,i,r,u,f,e,o,s){var a=this,h=t||{pageData:{}},c=n.base={basicAndViewData:h.base.basicAndViewData,pageId:h.base.pageId,parentPageId:h.base.pageId,fileName:h.base.fileName,size:h.base.size||"md",js:h.pageData.pcController,html:h.pageData.pcHtml,title:h.pageData.pageName,aliasTables:h.base.aliasTables,close:function(t){n.$close(t)},$pageLang:mabp.localization["Bpm."+app.language],ruleL:_shared.languageSetting.defaultRules[app.language],language:app.language,parameter:h.param,$loaded:h.base.$loaded,$queryString:h.base.$queryString,$viewDialog:i},l=n.form={$pageLang:h.form.$pageLang,$errors:[],$openDialog:function(t,i,r,u){s.open(t,n.base,n.form,i,r,u)},$timeout:h.form.$timeout,$watch:h.form.$watch,$save:function(n){a.prepaddareBasicDataAndExecute(n)},$delete:function(n){a.delete(n)},$toast:function(n){mabp.notify.error(n)},$timeout:o};o(function(){function t(n,t,i){if(angular.isFunction(i))f.callAsync(c.parentPageId,n,t,i);else return f.callSync(c.parentPageId,n,t);return null}eval(c.js);controller(c,l,t,n);var i=e(c.html)(n);angular.element("._page-dialog").eq(angular.element("._page-dialog").length-1).html(i);l.$validate=function(){return l.$errors=[],f.doFormValidate(n)};f.pageLoad(c,l);a.isLoaded=!0;f.pageLoaded(c,l);o(function(){$(".entire-block").css("visibility","visible");$(".entire-block").animate({opacity:"1"})},50)},50);a.prepaddareBasicDataAndExecute=function(t){var r,i;($(".fm-has-error").removeClass("fm-has-error"),r=f.validate(n),r)&&(i={tables:{}},_.forEach(c.aliasTables,function(n){i.tables[n]=mabp.toArray(t)}),i.id=t.id,i.pageId=c.pageId,u.saveBasicData(i).then(function(){l.$toast("保存成功");c.close(!0)}))};a.delete=function(n){var t={tables:{}};_.forEach(c.aliasTables,function(i){t.tables[i]=mabp.toArray(n)});t.id=n.id;t.pageId=c.pageId;u.deleteBasicData(t).then(function(){l.$toast("删除成功");c.close(!0)})};c.showErrorControl=function(n){var i=$(n.element).offset(),t=$(n.element).parents(".entire-block");t.animate({scrollTop:t.scrollTop()+i.top-100},300,"linear",function(){$(n.element).removeClass("fm-has-error");setTimeout(function(){$(n.element).addClass("fm-has-error");setTimeout(function(){$(n.element).removeClass("fm-has-error");setTimeout(function(){$(n.element).addClass("fm-has-error")},300)},300)},300)})}}]);_shared.service("$pageDialog",["mabp.app.page","dialog",function(n,t){var i={};return i.open=function(i,r,u,f,e,o){r.size=o&&o.size;n.getSubPage({parentPageId:r.pageId,moduleId:r.moduleId,fileName:i}).then(function(n){r.pageId=n.parentPageId;var o={fileName:i,base:r,form:u,param:f,pageData:n};o.pageData.pageName=r.titleNew===undefined?o.pageData.pageName:r.titleNew;t.open(_shared.dialogs.$pageDialog,o).then(function(n){e&&e(n)})})},i}])})();
/**** topic.dialog.js *****/
...
(function(){var n=_shared.dialogs.define("handledNodeSelect","/App/_shared_mobile/module/workflow/handledNode.select.html");_shared.controller(n,["$scope","dialog",function(n){var t=this;t.models=n.models;t.save=function(){t.selectNode?n.$close(t.selectNode):mabp.notify.warn("请选择一个节点！")};t.select=function(n){t.selectNode=n};t.cancel=function(){n.$close(!1)}}])})();
/**** moduleTransfer.js *****/
...
/**** raiseJob.select.js *****/
(function(){var n=_shared.dialogs.define("jobSelect","/App/_shared_mobile/module/workflow/raiseJob.select.html");_shared.controller(n,["$scope","dialog",function(n){var t=this;t.models=n.models;t.topicRequired=$systemConfig.workFlowConfig.topicRequired;t.topic=n.topic;t.selectJobId=t.models[0].jobId;t.save=function(){t.selectJobId&&(t.topic||!t.topicRequired)?n.$close({jobId:t.selectJobId,topic:t.topic}):t.topic?t.selectJobId||mabp.notify.warn("请选择一个岗位！"):mabp.notify.warn("主题不能为空！")};t.select=function(n){t.selectJobId=n.jobId};t.cancel=function(){n.$close(!1)}}])})();
