    ...
    angular.module('syspages').controller(controllerId, [
        ...
        function ($scope, module, service, dialog) {
            ...
            vm.load = function (isRefresh) {
				vm.paging.filters = [{ name: 'workflowId', value: vm.workflowId }, { name: 'filterText', value: vm.filterText }, { name: 'moduleType', value: '4' }];
			...
			vm.loadModuleType = function () {
				service.workFlowCountGroup({ type: 4 }).then(function (data) {
			...
			vm.edit = function (wf) {
				module.checkout(wf.appPageId, null, wf);
			}
